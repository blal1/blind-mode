...
public class WritableAttribute : Il2CppSystem.Attribute
{
	...
	static WritableAttribute()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WritableAttribute>.NativeClassPtr, 100663299);
	}
	...
	public WritableAttribute(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
