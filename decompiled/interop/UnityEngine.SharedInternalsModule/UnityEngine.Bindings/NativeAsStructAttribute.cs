...
public class NativeAsStructAttribute : Il2CppSystem.Attribute
{
	...
	static NativeAsStructAttribute()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NativeAsStructAttribute>.NativeClassPtr, 100663331);
	}
	...
	public NativeAsStructAttribute(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
