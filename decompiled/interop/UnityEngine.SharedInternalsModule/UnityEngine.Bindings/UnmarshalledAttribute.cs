...
public class UnmarshalledAttribute : Il2CppSystem.Attribute
{
	...
	static UnmarshalledAttribute()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnmarshalledAttribute>.NativeClassPtr, 100663340);
	}
	...
	public UnmarshalledAttribute(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
