...
public sealed class WriteOnlyAttribute : Il2CppSystem.Attribute
{
	...
	static WriteOnlyAttribute()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WriteOnlyAttribute>.NativeClassPtr, 100663509);
	}
	...
	public WriteOnlyAttribute(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
