...
public sealed class WaitWhile : CustomYieldInstruction
{
	...
	{
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1215201, XrefRangeEnd = 1215207, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
	...
	static WaitWhile()
	{
		...
		NativeFieldInfoPtr_m_Predicate = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitWhile>.NativeClassPtr, "m_Predicate");
		NativeFieldInfoPtr_m_TimeoutCallback = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitWhile>.NativeClassPtr, "m_TimeoutCallback");
		NativeFieldInfoPtr_m_TimeoutMode = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitWhile>.NativeClassPtr, "m_TimeoutMode");
		NativeFieldInfoPtr_m_MaxExecutionTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitWhile>.NativeClassPtr, "m_MaxExecutionTime");
		NativeMethodInfoPtr_get_keepWaiting_Public_Virtual_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitWhile>.NativeClassPtr, 100666591);
		NativeMethodInfoPtr__ctor_Public_Void_Func_1_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitWhile>.NativeClassPtr, 100666592);
		NativeMethodInfoPtr_GetTime_Private_Double_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitWhile>.NativeClassPtr, 100666593);
	}

	[CallerCount(24)]
	[CachedScanResults(RefRangeStart = 1215175, RefRangeEnd = 1215199, XrefRangeStart = 1215175, XrefRangeEnd = 1215199, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public WaitWhile(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
