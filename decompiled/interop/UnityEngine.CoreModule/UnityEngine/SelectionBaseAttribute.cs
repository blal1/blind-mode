...
public class SelectionBaseAttribute : Il2CppSystem.Attribute
{
	...
	static SelectionBaseAttribute()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SelectionBaseAttribute>.NativeClassPtr, 100666469);
	}
	...
	public SelectionBaseAttribute(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
