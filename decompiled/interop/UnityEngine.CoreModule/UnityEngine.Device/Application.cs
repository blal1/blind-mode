...
public static class Application
{
	...
	{
		UnityEngine.Application.add_focusChanged(value);
	}
	...
	{
		UnityEngine.Application.add_onBeforeRender(value);
	}
	...
	{
		UnityEngine.Application.add_quitting(value);
	}

	[SpecialName]
	public static void remove_quitting(Action value)
	{
		UnityEngine.Application.remove_quitting(value);
	}

	[SpecialName]
	public static void add_wantsToQuit(Func<bool> value)
	{
		UnityEngine.Application.add_wantsToQuit(value);
	}

	[SpecialName]
	public static void remove_wantsToQuit(Func<bool> value)
	{
		UnityEngine.Application.remove_wantsToQuit(value);
	}

	[SpecialName]
	public static void add_unloading(Action value)
	{
		UnityEngine.Application.add_unloading(value);
	}

	[SpecialName]
	public static void remove_unloading(Action value)
	{
		UnityEngine.Application.remove_unloading(value);
	}
