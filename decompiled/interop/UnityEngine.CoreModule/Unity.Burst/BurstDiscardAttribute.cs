...
public class BurstDiscardAttribute : Il2CppSystem.Attribute
{
	...
	static BurstDiscardAttribute()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BurstDiscardAttribute>.NativeClassPtr, 100663671);
	}
	...
	public BurstDiscardAttribute(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
