...
public class QRCodeReader : Il2CppSystem.Object
{
	...
	private static readonly System.IntPtr NativeMethodInfoPtr_moduleSize_Private_Static_Boolean_Il2CppStructArray_1_Int32_BitMatrix_byref_Single_0;
	...
	static QRCodeReader()
	{
		Il2CppClassPointerStore<QRCodeReader>.NativeClassPtr = IL2CPP.GetIl2CppClass("zxing.unity.dll", "ZXing.QrCode", "QRCodeReader");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<QRCodeReader>.NativeClassPtr);
		NativeFieldInfoPtr_NO_POINTS = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<QRCodeReader>.NativeClassPtr, "NO_POINTS");
		NativeFieldInfoPtr_decoder = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<QRCodeReader>.NativeClassPtr, "decoder");
		NativeMethodInfoPtr_decode_Public_Virtual_Final_New_Result_BinaryBitmap_IDictionary_2_DecodeHintType_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QRCodeReader>.NativeClassPtr, 100663553);
		NativeMethodInfoPtr_reset_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QRCodeReader>.NativeClassPtr, 100663554);
		NativeMethodInfoPtr_extractPureBits_Private_Static_BitMatrix_BitMatrix_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QRCodeReader>.NativeClassPtr, 100663555);
		NativeMethodInfoPtr_moduleSize_Private_Static_Boolean_Il2CppStructArray_1_Int32_BitMatrix_byref_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QRCodeReader>.NativeClassPtr, 100663556);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QRCodeReader>.NativeClassPtr, 100663557);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1413197, XrefRangeEnd = 1413246, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 1413267, RefRangeEnd = 1413268, XrefRangeStart = 1413246, XrefRangeEnd = 1413267, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1413268, XrefRangeEnd = 1413269, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe static bool moduleSize(Il2CppStructArray<int> leftTopBlack, BitMatrix image, out float msize)
	{
		...
		*(void**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(System.IntPtr)))) = Unsafe.AsPointer(ref msize);
		Unsafe.SkipInit(out System.IntPtr intPtr);
		System.IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_moduleSize_Private_Static_Boolean_Il2CppStructArray_1_Int32_BitMatrix_byref_Single_0, (System.IntPtr)0, (void**)ptr, ref intPtr);
		Il2CppException.RaiseExceptionIfNecessary(intPtr);
		return *(bool*)IL2CPP.il2cpp_object_unbox(intPtr2);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 1413284, RefRangeEnd = 1413285, XrefRangeStart = 1413269, XrefRangeEnd = 1413284, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe QRCodeReader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<QRCodeReader>.NativeClassPtr))
	{
		System.IntPtr* ptr = null;
		Unsafe.SkipInit(out System.IntPtr intPtr);
	...
	public QRCodeReader(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
