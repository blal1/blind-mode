...
using Il2CppZXing.Maxicode.Internal;

namespace Il2CppZXing.Maxicode;

public sealed class MaxiCodeReader : Il2CppSystem.Object
{
	...
	static MaxiCodeReader()
	{
		Il2CppClassPointerStore<MaxiCodeReader>.NativeClassPtr = IL2CPP.GetIl2CppClass("zxing.unity.dll", "ZXing.Maxicode", "MaxiCodeReader");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<MaxiCodeReader>.NativeClassPtr);
		NativeFieldInfoPtr_NO_POINTS = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MaxiCodeReader>.NativeClassPtr, "NO_POINTS");
		NativeFieldInfoPtr_decoder = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MaxiCodeReader>.NativeClassPtr, "decoder");
		NativeMethodInfoPtr_decode_Public_Virtual_Final_New_Result_BinaryBitmap_IDictionary_2_DecodeHintType_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MaxiCodeReader>.NativeClassPtr, 100664428);
		NativeMethodInfoPtr_reset_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MaxiCodeReader>.NativeClassPtr, 100664429);
		NativeMethodInfoPtr_extractPureBits_Private_Static_BitMatrix_BitMatrix_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MaxiCodeReader>.NativeClassPtr, 100664430);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MaxiCodeReader>.NativeClassPtr, 100664431);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1425526, XrefRangeEnd = 1425540, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 1425550, RefRangeEnd = 1425551, XrefRangeStart = 1425540, XrefRangeEnd = 1425550, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 1425566, RefRangeEnd = 1425567, XrefRangeStart = 1425551, XrefRangeEnd = 1425566, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe MaxiCodeReader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<MaxiCodeReader>.NativeClassPtr))
	{
		System.IntPtr* ptr = null;
		Unsafe.SkipInit(out System.IntPtr intPtr);
	...
	public MaxiCodeReader(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
