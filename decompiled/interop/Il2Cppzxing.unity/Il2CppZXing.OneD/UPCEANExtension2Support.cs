...
public sealed class UPCEANExtension2Support : Il2CppSystem.Object
{
	...
	static UPCEANExtension2Support()
	{
		Il2CppClassPointerStore<UPCEANExtension2Support>.NativeClassPtr = IL2CPP.GetIl2CppClass("zxing.unity.dll", "ZXing.OneD", "UPCEANExtension2Support");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<UPCEANExtension2Support>.NativeClassPtr);
		NativeFieldInfoPtr_decodeMiddleCounters = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<UPCEANExtension2Support>.NativeClassPtr, "decodeMiddleCounters");
		NativeFieldInfoPtr_decodeRowStringBuffer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<UPCEANExtension2Support>.NativeClassPtr, "decodeRowStringBuffer");
		NativeMethodInfoPtr_decodeRow_Internal_Result_Int32_BitArray_Il2CppStructArray_1_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UPCEANExtension2Support>.NativeClassPtr, 100664199);
		NativeMethodInfoPtr_decodeMiddle_Private_Int32_BitArray_Il2CppStructArray_1_Int32_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UPCEANExtension2Support>.NativeClassPtr, 100664200);
		NativeMethodInfoPtr_parseExtensionString_Private_Static_IDictionary_2_ResultMetadataType_Object_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UPCEANExtension2Support>.NativeClassPtr, 100664201);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UPCEANExtension2Support>.NativeClassPtr, 100664202);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 1423512, RefRangeEnd = 1423514, XrefRangeStart = 1423475, XrefRangeEnd = 1423512, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 1423526, RefRangeEnd = 1423527, XrefRangeStart = 1423514, XrefRangeEnd = 1423526, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1423527, XrefRangeEnd = 1423542, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1423542, XrefRangeEnd = 1423552, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe UPCEANExtension2Support()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<UPCEANExtension2Support>.NativeClassPtr))
	{
	...
	public UPCEANExtension2Support(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
