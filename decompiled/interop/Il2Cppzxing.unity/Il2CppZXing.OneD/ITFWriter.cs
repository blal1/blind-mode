...
{
	private static readonly IntPtr NativeFieldInfoPtr_START_PATTERN;

	private static readonly IntPtr NativeFieldInfoPtr_END_PATTERN;
	...
	{
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1422413, XrefRangeEnd = 1422417, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
	...
	static ITFWriter()
	{
		Il2CppClassPointerStore<ITFWriter>.NativeClassPtr = IL2CPP.GetIl2CppClass("zxing.unity.dll", "ZXing.OneD", "ITFWriter");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ITFWriter>.NativeClassPtr);
		NativeFieldInfoPtr_START_PATTERN = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ITFWriter>.NativeClassPtr, "START_PATTERN");
		NativeFieldInfoPtr_END_PATTERN = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ITFWriter>.NativeClassPtr, "END_PATTERN");
		NativeFieldInfoPtr_PATTERNS = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ITFWriter>.NativeClassPtr, "PATTERNS");
		NativeFieldInfoPtr_supportedWriteFormats = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ITFWriter>.NativeClassPtr, "supportedWriteFormats");
		NativeMethodInfoPtr_get_SupportedWriteFormats_Protected_Virtual_get_IList_1_BarcodeFormat_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ITFWriter>.NativeClassPtr, 100664125);
		NativeMethodInfoPtr_encode_Public_Virtual_Il2CppStructArray_1_Boolean_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ITFWriter>.NativeClassPtr, 100664126);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ITFWriter>.NativeClassPtr, 100664127);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1422417, XrefRangeEnd = 1422460, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 1422464, RefRangeEnd = 1422465, XrefRangeStart = 1422460, XrefRangeEnd = 1422464, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ITFWriter()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ITFWriter>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr);
	...
	public ITFWriter(IntPtr pointer)
		: base(pointer)
	{
	}
}
