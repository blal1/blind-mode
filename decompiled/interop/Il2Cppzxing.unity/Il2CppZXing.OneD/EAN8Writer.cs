...
public sealed class EAN8Writer : UPCEANWriter
{
	...
	{
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1421530, XrefRangeEnd = 1421534, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
	...
	static EAN8Writer()
	{
		Il2CppClassPointerStore<EAN8Writer>.NativeClassPtr = IL2CPP.GetIl2CppClass("zxing.unity.dll", "ZXing.OneD", "EAN8Writer");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<EAN8Writer>.NativeClassPtr);
		NativeFieldInfoPtr_supportedWriteFormats = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EAN8Writer>.NativeClassPtr, "supportedWriteFormats");
		NativeMethodInfoPtr_get_SupportedWriteFormats_Protected_Virtual_get_IList_1_BarcodeFormat_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EAN8Writer>.NativeClassPtr, 100664107);
		NativeMethodInfoPtr_encode_Public_Virtual_Il2CppStructArray_1_Boolean_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EAN8Writer>.NativeClassPtr, 100664108);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EAN8Writer>.NativeClassPtr, 100664109);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1421534, XrefRangeEnd = 1421587, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(3)]
	[CachedScanResults(RefRangeStart = 1421500, RefRangeEnd = 1421503, XrefRangeStart = 1421500, XrefRangeEnd = 1421503, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe EAN8Writer()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<EAN8Writer>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr);
	...
	public EAN8Writer(IntPtr pointer)
		: base(pointer)
	{
	}
}
