...
public sealed class DataBlock : Il2CppSystem.Object
{
	...
	private static readonly System.IntPtr NativeMethodInfoPtr_getDataBlocks_Internal_Static_Il2CppReferenceArray_1_DataBlock_Il2CppStructArray_1_Byte_Version_ErrorCorrectionLevel_0;
	...
	static DataBlock()
	{
		Il2CppClassPointerStore<DataBlock>.NativeClassPtr = IL2CPP.GetIl2CppClass("zxing.unity.dll", "ZXing.QrCode.Internal", "DataBlock");
		...
		NativeMethodInfoPtr__ctor_Private_Void_Int32_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DataBlock>.NativeClassPtr, 100663571);
		NativeMethodInfoPtr_getDataBlocks_Internal_Static_Il2CppReferenceArray_1_DataBlock_Il2CppStructArray_1_Byte_Version_ErrorCorrectionLevel_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DataBlock>.NativeClassPtr, 100663572);
		NativeMethodInfoPtr_get_NumDataCodewords_Internal_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DataBlock>.NativeClassPtr, 100663573);
		NativeMethodInfoPtr_get_Codewords_Internal_get_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DataBlock>.NativeClassPtr, 100663574);
	}
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 1413423, RefRangeEnd = 1413424, XrefRangeStart = 1413409, XrefRangeEnd = 1413423, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe static Il2CppReferenceArray<DataBlock> getDataBlocks(Il2CppStructArray<byte> rawCodewords, Version version, ErrorCorrectionLevel ecLevel)
	{
		...
		*(System.IntPtr*)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(System.IntPtr)))) = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)ecLevel);
		Unsafe.SkipInit(out System.IntPtr intPtr);
		System.IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_getDataBlocks_Internal_Static_Il2CppReferenceArray_1_DataBlock_Il2CppStructArray_1_Byte_Version_ErrorCorrectionLevel_0, (System.IntPtr)0, (void**)ptr, ref intPtr);
		Il2CppException.RaiseExceptionIfNecessary(intPtr);
