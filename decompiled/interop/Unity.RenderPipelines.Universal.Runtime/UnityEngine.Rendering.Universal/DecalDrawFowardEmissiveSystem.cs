...
public class DecalDrawFowardEmissiveSystem : DecalDrawSystem
{
	...
	static DecalDrawFowardEmissiveSystem()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_DecalEntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DecalDrawFowardEmissiveSystem>.NativeClassPtr, 100663977);
		NativeMethodInfoPtr_GetPassIndex_Protected_Virtual_Int32_DecalCachedChunk_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DecalDrawFowardEmissiveSystem>.NativeClassPtr, 100663978);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 1081002, RefRangeEnd = 1081003, XrefRangeStart = 1080996, XrefRangeEnd = 1081002, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
