...
public class DecalPreviewPass : ScriptableRenderPass
{
	public class PassData : Il2CppSystem.Object
	{
		...
		static PassData()
		{
			Il2CppClassPointerStore<PassData>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<DecalPreviewPass>.NativeClassPtr, "PassData");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassData>.NativeClassPtr, 100663996);
		}
	...
	[System.Serializable]
	[ObfuscatedName("UnityEngine.Rendering.Universal.DecalPreviewPass+<>c")]
	public sealed class __c : Il2CppSystem.Object
	{
		...
		private static readonly System.IntPtr NativeMethodInfoPtr__RecordRenderGraph_b__8_0_Internal_Void_PassData_RasterGraphContext_0;
		...
		public unsafe static BaseRenderFunc<PassData, RasterGraphContext> __9__8_0
		{
			get
			{
				Unsafe.SkipInit(out System.IntPtr intPtr);
		...
		static __c()
		{
			Il2CppClassPointerStore<__c>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<DecalPreviewPass>.NativeClassPtr, "<>c");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__c>.NativeClassPtr, 100663998);
			NativeMethodInfoPtr__RecordRenderGraph_b__8_0_Internal_Void_PassData_RasterGraphContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__c>.NativeClassPtr, 100663999);
		}
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1081164, XrefRangeEnd = 1081166, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe void _RecordRenderGraph_b__8_0(PassData data, RasterGraphContext rgContext)
		{
			...
			*(System.IntPtr*)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(System.IntPtr)))) = IL2CPP.il2cpp_object_unbox(IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)rgContext));
			Unsafe.SkipInit(out System.IntPtr intPtr);
			System.IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__RecordRenderGraph_b__8_0_Internal_Void_PassData_RasterGraphContext_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr);
			Il2CppException.RaiseExceptionIfNecessary(intPtr);
		}
	...
	static DecalPreviewPass()
	{
		...
		NativeFieldInfoPtr_m_FilteringSettings = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DecalPreviewPass>.NativeClassPtr, "m_FilteringSettings");
		NativeFieldInfoPtr_m_ShaderTagIdList = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DecalPreviewPass>.NativeClassPtr, "m_ShaderTagIdList");
		NativeFieldInfoPtr_m_ProfilingSampler = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DecalPreviewPass>.NativeClassPtr, "m_ProfilingSampler");
		NativeFieldInfoPtr_m_PassData = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DecalPreviewPass>.NativeClassPtr, "m_PassData");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DecalPreviewPass>.NativeClassPtr, 100663992);
		NativeMethodInfoPtr_Execute_Public_Virtual_Void_ScriptableRenderContext_byref_RenderingData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DecalPreviewPass>.NativeClassPtr, 100663993);
		NativeMethodInfoPtr_ExecutePass_Private_Static_Void_RasterCommandBuffer_PassData_RendererList_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DecalPreviewPass>.NativeClassPtr, 100663994);
		NativeMethodInfoPtr_RecordRenderGraph_Public_Virtual_Void_RenderGraph_ContextContainer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DecalPreviewPass>.NativeClassPtr, 100663995);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 1081204, RefRangeEnd = 1081205, XrefRangeStart = 1081166, XrefRangeEnd = 1081204, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1081205, XrefRangeEnd = 1081238, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1081238, XrefRangeEnd = 1081239, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1081239, XrefRangeEnd = 1081307, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public DecalPreviewPass(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
