...
public static class RenderPassEventsEnumValues : Il2CppSystem.Object
{
	...
	static RenderPassEventsEnumValues()
	{
		...
		NativeFieldInfoPtr_values = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RenderPassEventsEnumValues>.NativeClassPtr, "values");
	}

	public RenderPassEventsEnumValues(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
