...
public sealed class Fixed2<T> : Il2CppSystem.ValueType where T : new()
{
	...
	private static readonly System.IntPtr NativeMethodInfoPtr__ctor_Public_Void_T_T_0;
	...
	private static readonly System.IntPtr NativeMethodInfoPtr_CheckRange_Private_Static_Void_Int32_0;
	...
	{
		[CallerCount(18)]
		[CachedScanResults(RefRangeStart = 1023632, RefRangeEnd = 1023650, XrefRangeStart = 1023632, XrefRangeEnd = 1023650, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
	...
	static Fixed2()
	{
		Il2CppClassPointerStore<Fixed2<T>>.NativeClassPtr = IL2CPP.il2cpp_class_from_type(Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(IL2CPP.GetIl2CppClass("Unity.RenderPipelines.Universal.Runtime.dll", "UnityEngine.Rendering.Universal", "Fixed2`1"))).MakeGenericType(new Il2CppReferenceArray<Il2CppSystem.Type>(new Il2CppSystem.Type[1] { Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<T>.NativeClassPtr)) })).TypeHandle.value);
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Fixed2<T>>.NativeClassPtr);
		NativeFieldInfoPtr_item1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Fixed2<T>>.NativeClassPtr, "item1");
		NativeFieldInfoPtr_item2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Fixed2<T>>.NativeClassPtr, "item2");
		NativeMethodInfoPtr__ctor_Public_Void_T_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Fixed2<T>>.NativeClassPtr, 100664759);
		NativeMethodInfoPtr__ctor_Public_Void_T_T_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Fixed2<T>>.NativeClassPtr, 100664760);
		NativeMethodInfoPtr_get_Item_Public_get_T_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Fixed2<T>>.NativeClassPtr, 100664761);
		NativeMethodInfoPtr_set_Item_Public_set_Void_Int32_T_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Fixed2<T>>.NativeClassPtr, 100664762);
		NativeMethodInfoPtr_CheckRange_Private_Static_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Fixed2<T>>.NativeClassPtr, 100664763);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1088417, XrefRangeEnd = 1088418, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Fixed2<T>>.NativeClassPtr))
	{
		...
		*(void**)num = Unsafe.AsPointer(ref reference2);
		Unsafe.SkipInit(out System.IntPtr intPtr);
		System.IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_T_T_0, IL2CPP.il2cpp_object_unbox(IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this)), (void**)ptr, ref intPtr);
		Il2CppException.RaiseExceptionIfNecessary(intPtr);
	}
	...
	public unsafe static void CheckRange(int index)
	{
		...
		*ptr = (nint)(&index);
		Unsafe.SkipInit(out System.IntPtr intPtr);
		System.IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_CheckRange_Private_Static_Void_Int32_0, (System.IntPtr)0, (void**)ptr, ref intPtr);
		Il2CppException.RaiseExceptionIfNecessary(intPtr);
	}

	public Fixed2(System.IntPtr pointer)
		: base(pointer)
	{
	}
