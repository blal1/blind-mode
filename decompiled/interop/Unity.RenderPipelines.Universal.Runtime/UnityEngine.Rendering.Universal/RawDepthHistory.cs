...
public sealed class RawDepthHistory : CameraHistoryItem
{
	...
	static RawDepthHistory()
	{
		Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr = IL2CPP.GetIl2CppClass("Unity.RenderPipelines.Universal.Runtime.dll", "UnityEngine.Rendering.Universal", "RawDepthHistory");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr);
		NativeFieldInfoPtr_m_Ids = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, "m_Ids");
		NativeFieldInfoPtr_m_Names = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, "m_Names");
		NativeFieldInfoPtr_m_Descriptor = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, "m_Descriptor");
		NativeFieldInfoPtr_m_DescKey = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, "m_DescKey");
		NativeMethodInfoPtr_OnCreate_Public_Virtual_Void_BufferedRTHandleSystem_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, 100664642);
		NativeMethodInfoPtr_GetCurrentTexture_Public_RTHandle_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, 100664643);
		NativeMethodInfoPtr_GetPreviousTexture_Public_RTHandle_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, 100664644);
		NativeMethodInfoPtr_IsAllocated_Private_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, 100664645);
		NativeMethodInfoPtr_IsDirty_Private_Boolean_byref_RenderTextureDescriptor_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, 100664646);
		NativeMethodInfoPtr_Alloc_Private_Void_byref_RenderTextureDescriptor_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, 100664647);
		NativeMethodInfoPtr_Reset_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, 100664648);
		NativeMethodInfoPtr_GetHistoryDescriptor_Internal_RenderTextureDescriptor_byref_RenderTextureDescriptor_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, 100664649);
		NativeMethodInfoPtr_Update_Internal_Boolean_byref_RenderTextureDescriptor_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, 100664650);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr, 100664651);
	}
	...
	[CallerCount(12)]
	[CachedScanResults(RefRangeStart = 1087547, RefRangeEnd = 1087559, XrefRangeStart = 1087547, XrefRangeEnd = 1087559, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1087605, XrefRangeEnd = 1087609, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1087609, XrefRangeEnd = 1087621, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 1087640, RefRangeEnd = 1087642, XrefRangeStart = 1087621, XrefRangeEnd = 1087640, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe bool Update(ref RenderTextureDescriptor cameraDesc, bool xrMultipassEnabled)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[2];
		*ptr = (nint)Unsafe.AsPointer(ref cameraDesc);
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1087642, XrefRangeEnd = 1087681, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe RawDepthHistory()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<RawDepthHistory>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr);
	...
	public RawDepthHistory(IntPtr pointer)
		: base(pointer)
	{
	}
}
