...
public class VFXPositionBinder : VFXSpaceableBinder
{
	...
	public unsafe string Property
	{
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1146739, XrefRangeEnd = 1146741, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		set
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
	...
	static VFXPositionBinder()
	{
		Il2CppClassPointerStore<VFXPositionBinder>.NativeClassPtr = IL2CPP.GetIl2CppClass("Unity.VisualEffectGraph.Runtime.dll", "UnityEngine.VFX.Utility", "VFXPositionBinder");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<VFXPositionBinder>.NativeClassPtr);
		NativeFieldInfoPtr_m_Property = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VFXPositionBinder>.NativeClassPtr, "m_Property");
		NativeFieldInfoPtr_Target = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VFXPositionBinder>.NativeClassPtr, "Target");
		NativeMethodInfoPtr_get_Property_Public_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXPositionBinder>.NativeClassPtr, 100663689);
		NativeMethodInfoPtr_set_Property_Public_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXPositionBinder>.NativeClassPtr, 100663690);
		NativeMethodInfoPtr_IsValid_Public_Virtual_Boolean_VisualEffect_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXPositionBinder>.NativeClassPtr, 100663691);
		NativeMethodInfoPtr_UpdateBinding_Public_Virtual_Void_VisualEffect_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXPositionBinder>.NativeClassPtr, 100663692);
		NativeMethodInfoPtr_ToString_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXPositionBinder>.NativeClassPtr, 100663693);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXPositionBinder>.NativeClassPtr, 100663694);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1146741, XrefRangeEnd = 1146745, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1146745, XrefRangeEnd = 1146752, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1146752, XrefRangeEnd = 1146764, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1146764, XrefRangeEnd = 1146769, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe VFXPositionBinder()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<VFXPositionBinder>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr);
	...
	public VFXPositionBinder(IntPtr pointer)
		: base(pointer)
	{
	}
}
