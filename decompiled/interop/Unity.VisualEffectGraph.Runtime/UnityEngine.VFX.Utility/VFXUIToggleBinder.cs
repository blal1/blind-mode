...
public class VFXUIToggleBinder : VFXBinderBase
{
	...
	static VFXUIToggleBinder()
	{
		Il2CppClassPointerStore<VFXUIToggleBinder>.NativeClassPtr = IL2CPP.GetIl2CppClass("Unity.VisualEffectGraph.Runtime.dll", "UnityEngine.VFX.Utility", "VFXUIToggleBinder");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<VFXUIToggleBinder>.NativeClassPtr);
		NativeFieldInfoPtr_m_Property = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VFXUIToggleBinder>.NativeClassPtr, "m_Property");
		NativeFieldInfoPtr_Target = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VFXUIToggleBinder>.NativeClassPtr, "Target");
		NativeMethodInfoPtr_get_Property_Public_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXUIToggleBinder>.NativeClassPtr, 100663759);
		NativeMethodInfoPtr_set_Property_Public_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXUIToggleBinder>.NativeClassPtr, 100663760);
		NativeMethodInfoPtr_IsValid_Public_Virtual_Boolean_VisualEffect_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXUIToggleBinder>.NativeClassPtr, 100663761);
		NativeMethodInfoPtr_UpdateBinding_Public_Virtual_Void_VisualEffect_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXUIToggleBinder>.NativeClassPtr, 100663762);
		NativeMethodInfoPtr_ToString_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXUIToggleBinder>.NativeClassPtr, 100663763);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXUIToggleBinder>.NativeClassPtr, 100663764);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1147188, XrefRangeEnd = 1147192, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1147192, XrefRangeEnd = 1147195, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1147195, XrefRangeEnd = 1147207, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1147207, XrefRangeEnd = 1147212, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe VFXUIToggleBinder()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<VFXUIToggleBinder>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr);
	...
	public VFXUIToggleBinder(IntPtr pointer)
		: base(pointer)
	{
	}
}
