...
{
	[OriginalName("Unity.VisualEffectGraph.Runtime.dll", "", "Check")]
	public enum Check
	{
		ActiveInHierarchy,
		ActiveSelf
	...
	public unsafe Check check
	{
		...
		set
		{
			*(Check*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_check)) = value;
		}
	}
	...
	static VFXEnabledBinder()
	{
		Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr = IL2CPP.GetIl2CppClass("Unity.VisualEffectGraph.Runtime.dll", "UnityEngine.VFX.Utility", "VFXEnabledBinder");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr);
		NativeFieldInfoPtr_check = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr, "check");
		NativeFieldInfoPtr_m_Property = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr, "m_Property");
		NativeFieldInfoPtr_Target = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr, "Target");
		NativeMethodInfoPtr_get_Property_Public_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr, 100663595);
		NativeMethodInfoPtr_set_Property_Public_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr, 100663596);
		NativeMethodInfoPtr_IsValid_Public_Virtual_Boolean_VisualEffect_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr, 100663597);
		NativeMethodInfoPtr_UpdateBinding_Public_Virtual_Void_VisualEffect_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr, 100663598);
		NativeMethodInfoPtr_ToString_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr, 100663599);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr, 100663600);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1145902, XrefRangeEnd = 1145906, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1145906, XrefRangeEnd = 1145919, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1145919, XrefRangeEnd = 1145933, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1145933, XrefRangeEnd = 1145942, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe VFXEnabledBinder()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<VFXEnabledBinder>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr);
	...
	public VFXEnabledBinder(IntPtr pointer)
		: base(pointer)
	{
	}
}
