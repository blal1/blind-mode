...
public sealed class PKCS1 : Il2CppSystem.Object
{
	...
	private static readonly System.IntPtr NativeMethodInfoPtr_HashNameFromOid_Internal_Static_String_String_Boolean_0;

	private static readonly System.IntPtr NativeMethodInfoPtr_CreateFromOid_Internal_Static_HashAlgorithm_String_0;
	...
	static PKCS1()
	{
		...
		NativeMethodInfoPtr_Compare_Private_Static_Boolean_Il2CppStructArray_1_Byte_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PKCS1>.NativeClassPtr, 100663708);
		NativeMethodInfoPtr_I2OSP_Public_Static_Il2CppStructArray_1_Byte_Il2CppStructArray_1_Byte_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PKCS1>.NativeClassPtr, 100663709);
		NativeMethodInfoPtr_OS2IP_Public_Static_Il2CppStructArray_1_Byte_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PKCS1>.NativeClassPtr, 100663710);
		NativeMethodInfoPtr_RSAVP1_Public_Static_Il2CppStructArray_1_Byte_RSA_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PKCS1>.NativeClassPtr, 100663711);
		NativeMethodInfoPtr_Verify_v15_Public_Static_Boolean_RSA_HashAlgorithm_Il2CppStructArray_1_Byte_Il2CppStructArray_1_Byte_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PKCS1>.NativeClassPtr, 100663712);
		NativeMethodInfoPtr_Encode_v15_Public_Static_Il2CppStructArray_1_Byte_HashAlgorithm_Il2CppStructArray_1_Byte_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PKCS1>.NativeClassPtr, 100663713);
		NativeMethodInfoPtr_HashNameFromOid_Internal_Static_String_String_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PKCS1>.NativeClassPtr, 100663714);
		NativeMethodInfoPtr_CreateFromOid_Internal_Static_HashAlgorithm_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PKCS1>.NativeClassPtr, 100663715);
		NativeMethodInfoPtr_CreateFromName_Internal_Static_HashAlgorithm_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PKCS1>.NativeClassPtr, 100663716);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 693819, XrefRangeEnd = 693820, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 693820, XrefRangeEnd = 693824, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 693824, XrefRangeEnd = 693825, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 693825, XrefRangeEnd = 693826, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 693848, RefRangeEnd = 693849, XrefRangeStart = 693826, XrefRangeEnd = 693848, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 693886, RefRangeEnd = 693887, XrefRangeStart = 693849, XrefRangeEnd = 693886, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(5)]
	[CachedScanResults(RefRangeStart = 693910, RefRangeEnd = 693915, XrefRangeStart = 693887, XrefRangeEnd = 693910, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe static string HashNameFromOid(string oid, bool throwOnError = true)
	{
		...
		*(bool**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(System.IntPtr)))) = &throwOnError;
		Unsafe.SkipInit(out System.IntPtr intPtr);
		System.IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_HashNameFromOid_Internal_Static_String_String_Boolean_0, (System.IntPtr)0, (void**)ptr, ref intPtr);
		Il2CppException.RaiseExceptionIfNecessary(intPtr);
		return IL2CPP.Il2CppStringToManaged(intPtr2);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 693920, RefRangeEnd = 693921, XrefRangeStart = 693915, XrefRangeEnd = 693920, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe static HashAlgorithm CreateFromOid(string oid)
	{
		System.IntPtr* ptr = stackalloc System.IntPtr[1];
		*ptr = IL2CPP.ManagedStringToIl2Cpp(oid);
		Unsafe.SkipInit(out System.IntPtr intPtr);
		System.IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_CreateFromOid_Internal_Static_HashAlgorithm_String_0, (System.IntPtr)0, (void**)ptr, ref intPtr);
		Il2CppException.RaiseExceptionIfNecessary(intPtr);
		return (intPtr2 != (System.IntPtr)0) ? Il2CppObjectPool.Get<HashAlgorithm>(intPtr2) : null;
	}

	[CallerCount(3)]
	[CachedScanResults(RefRangeStart = 693937, RefRangeEnd = 693940, XrefRangeStart = 693921, XrefRangeEnd = 693937, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
