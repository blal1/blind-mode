...
public class AsyncWriteRequest : AsyncReadOrWriteRequest
{
	...
	static AsyncWriteRequest()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_MobileAuthenticatedStream_Boolean_Il2CppStructArray_1_Byte_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AsyncWriteRequest>.NativeClassPtr, 100663507);
		NativeMethodInfoPtr_Run_Protected_Virtual_AsyncOperationStatus_AsyncOperationStatus_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AsyncWriteRequest>.NativeClassPtr, 100663508);
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 863494, XrefRangeEnd = 863495, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
