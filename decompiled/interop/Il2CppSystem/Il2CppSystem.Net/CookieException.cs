...
public class CookieException : FormatException
{
	...
	private static readonly System.IntPtr NativeMethodInfoPtr__ctor_Internal_Void_String_Exception_0;
	...
	static CookieException()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CookieException>.NativeClassPtr, 100666465);
		NativeMethodInfoPtr__ctor_Internal_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CookieException>.NativeClassPtr, 100666466);
		NativeMethodInfoPtr__ctor_Internal_Void_String_Exception_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CookieException>.NativeClassPtr, 100666467);
		NativeMethodInfoPtr__ctor_Protected_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CookieException>.NativeClassPtr, 100666468);
		NativeMethodInfoPtr_System_Runtime_Serialization_ISerializable_GetObjectData_Private_Virtual_Final_New_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CookieException>.NativeClassPtr, 100666469);
		NativeMethodInfoPtr_GetObjectData_Public_Virtual_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CookieException>.NativeClassPtr, 100666470);
	}
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 871138, RefRangeEnd = 871139, XrefRangeStart = 871138, XrefRangeEnd = 871139, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 890588, XrefRangeEnd = 890589, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CookieException>.NativeClassPtr))
	{
		...
		*(System.IntPtr*)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(System.IntPtr)))) = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)inner);
		Unsafe.SkipInit(out System.IntPtr intPtr);
		System.IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Internal_Void_String_Exception_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr);
		Il2CppException.RaiseExceptionIfNecessary(intPtr);
	}
	...
	public CookieException(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
