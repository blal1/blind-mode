...
public class ProtocolViolationException : InvalidOperationException
{
	...
	static ProtocolViolationException()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProtocolViolationException>.NativeClassPtr, 100666169);
		NativeMethodInfoPtr__ctor_Public_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProtocolViolationException>.NativeClassPtr, 100666170);
		NativeMethodInfoPtr__ctor_Protected_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProtocolViolationException>.NativeClassPtr, 100666171);
		NativeMethodInfoPtr_System_Runtime_Serialization_ISerializable_GetObjectData_Private_Virtual_Final_New_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProtocolViolationException>.NativeClassPtr, 100666172);
		NativeMethodInfoPtr_GetObjectData_Public_Virtual_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProtocolViolationException>.NativeClassPtr, 100666173);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 887842, XrefRangeEnd = 887843, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 887843, XrefRangeEnd = 887844, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ProtocolViolationException(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
