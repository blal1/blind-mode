...
public class FileWebRequestCreator : Object
{
	...
	static FileWebRequestCreator()
	{
		...
		NativeMethodInfoPtr__ctor_Internal_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileWebRequestCreator>.NativeClassPtr, 100666495);
		NativeMethodInfoPtr_Create_Public_Virtual_Final_New_WebRequest_Uri_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileWebRequestCreator>.NativeClassPtr, 100666496);
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 890858, XrefRangeEnd = 890880, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public FileWebRequestCreator(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
