...
public class UriFormatException : FormatException
{
	...
	static UriFormatException()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UriFormatException>.NativeClassPtr, 100664289);
		NativeMethodInfoPtr__ctor_Public_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UriFormatException>.NativeClassPtr, 100664290);
		NativeMethodInfoPtr__ctor_Protected_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UriFormatException>.NativeClassPtr, 100664291);
		NativeMethodInfoPtr_System_Runtime_Serialization_ISerializable_GetObjectData_Private_Virtual_Final_New_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UriFormatException>.NativeClassPtr, 100664292);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 871136, XrefRangeEnd = 871137, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 871138, RefRangeEnd = 871139, XrefRangeStart = 871137, XrefRangeEnd = 871138, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 871139, XrefRangeEnd = 871140, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public UriFormatException(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
