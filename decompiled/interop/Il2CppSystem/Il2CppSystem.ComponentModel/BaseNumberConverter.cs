...
public class BaseNumberConverter : TypeConverter
{
	...
	static BaseNumberConverter()
	{
		...
		NativeMethodInfoPtr__ctor_Internal_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BaseNumberConverter>.NativeClassPtr, 100665260);
	}
	...
	public BaseNumberConverter(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
