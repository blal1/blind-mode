...
public sealed class SocketElement : ConfigurationElement
{
	...
	{
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 900620, XrefRangeEnd = 900623, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
	...
	static SocketElement()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SocketElement>.NativeClassPtr, 100667561);
		NativeMethodInfoPtr_get_Properties_Protected_Virtual_get_ConfigurationPropertyCollection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SocketElement>.NativeClassPtr, 100667562);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 900617, XrefRangeEnd = 900620, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public SocketElement(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
