...
public sealed class PerformanceCountersElement : ConfigurationElement
{
	...
	{
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 900608, XrefRangeEnd = 900611, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
	...
	static PerformanceCountersElement()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PerformanceCountersElement>.NativeClassPtr, 100667557);
		NativeMethodInfoPtr_get_Properties_Protected_Virtual_get_ConfigurationPropertyCollection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PerformanceCountersElement>.NativeClassPtr, 100667558);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 900605, XrefRangeEnd = 900608, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public PerformanceCountersElement(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
