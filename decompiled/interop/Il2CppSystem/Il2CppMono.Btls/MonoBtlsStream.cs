...
public class MonoBtlsStream : MobileAuthenticatedStream
{
	...
	static MonoBtlsStream()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_Stream_Boolean_SslStream_MonoTlsSettings_MobileTlsProvider_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MonoBtlsStream>.NativeClassPtr, 100663921);
		NativeMethodInfoPtr_CreateContext_Protected_Virtual_MobileTlsContext_MonoSslAuthenticationOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MonoBtlsStream>.NativeClassPtr, 100663922);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 866850, RefRangeEnd = 866851, XrefRangeStart = 866846, XrefRangeEnd = 866850, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 866851, XrefRangeEnd = 866855, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
