...
public sealed class ThrowStub : Il2CppSystem.ObjectDisposedException
{
	...
	static ThrowStub()
	{
		...
		NativeMethodInfoPtr_ThrowNotSupportedException_Public_Static_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ThrowStub>.NativeClassPtr, 100667570);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 900646, XrefRangeEnd = 900651, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
