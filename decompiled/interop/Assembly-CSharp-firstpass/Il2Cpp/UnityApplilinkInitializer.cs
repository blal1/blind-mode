...
{
	[OriginalName("Assembly-CSharp-firstpass.dll", "", "VerboseType")]
	...
	[OriginalName("Assembly-CSharp-firstpass.dll", "", "AdType")]
	public enum AdType
	{
		Recommend,
		Reward
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 23050, XrefRangeEnd = 23083, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 23083, XrefRangeEnd = 23092, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
