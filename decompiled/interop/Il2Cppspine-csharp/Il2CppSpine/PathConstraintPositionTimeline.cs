...
public class PathConstraintPositionTimeline : CurveTimeline1
{
	...
	{
		Il2CppClassPointerStore<PathConstraintPositionTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "PathConstraintPositionTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PathConstraintPositionTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_constraintIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PathConstraintPositionTimeline>.NativeClassPtr, "constraintIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PathConstraintPositionTimeline>.NativeClassPtr, 100663439);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PathConstraintPositionTimeline>.NativeClassPtr, 100663440);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 841303, RefRangeEnd = 841305, XrefRangeStart = 841297, XrefRangeEnd = 841303, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PathConstraintPositionTimeline(int frameCount, int bezierCount, int pathConstraintIndex)
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 841305, XrefRangeEnd = 841306, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
