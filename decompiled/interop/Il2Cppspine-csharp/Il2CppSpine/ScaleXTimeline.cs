...
public class ScaleXTimeline : CurveTimeline1
{
	...
	static ScaleXTimeline()
	{
		Il2CppClassPointerStore<ScaleXTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "ScaleXTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ScaleXTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_boneIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ScaleXTimeline>.NativeClassPtr, "boneIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleXTimeline>.NativeClassPtr, 100663373);
		NativeMethodInfoPtr_get_BoneIndex_Public_Virtual_Final_New_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleXTimeline>.NativeClassPtr, 100663374);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleXTimeline>.NativeClassPtr, 100663375);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 840910, RefRangeEnd = 840912, XrefRangeStart = 840904, XrefRangeEnd = 840910, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ScaleXTimeline(int frameCount, int bezierCount, int boneIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ScaleXTimeline>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 840912, XrefRangeEnd = 840913, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ScaleXTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
