...
public class PhysicsConstraintMassTimeline : PhysicsConstraintTimeline
{
	...
	static PhysicsConstraintMassTimeline()
	{
		Il2CppClassPointerStore<PhysicsConstraintMassTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "PhysicsConstraintMassTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PhysicsConstraintMassTimeline>.NativeClassPtr);
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintMassTimeline>.NativeClassPtr, 100663468);
		NativeMethodInfoPtr_Setup_Protected_Virtual_Single_PhysicsConstraint_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintMassTimeline>.NativeClassPtr, 100663469);
		NativeMethodInfoPtr_Get_Protected_Virtual_Single_PhysicsConstraint_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintMassTimeline>.NativeClassPtr, 100663470);
		NativeMethodInfoPtr_Set_Protected_Virtual_Void_PhysicsConstraint_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintMassTimeline>.NativeClassPtr, 100663471);
		NativeMethodInfoPtr_Global_Protected_Virtual_Boolean_PhysicsConstraintData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintMassTimeline>.NativeClassPtr, 100663472);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 841356, RefRangeEnd = 841358, XrefRangeStart = 841355, XrefRangeEnd = 841356, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PhysicsConstraintMassTimeline(int frameCount, int bezierCount, int physicsConstraintIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PhysicsConstraintMassTimeline>.NativeClassPtr))
	{
	...
	public PhysicsConstraintMassTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
