...
public class ScaleYTimeline : CurveTimeline1
{
	...
	static ScaleYTimeline()
	{
		Il2CppClassPointerStore<ScaleYTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "ScaleYTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ScaleYTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_boneIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ScaleYTimeline>.NativeClassPtr, "boneIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleYTimeline>.NativeClassPtr, 100663376);
		NativeMethodInfoPtr_get_BoneIndex_Public_Virtual_Final_New_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleYTimeline>.NativeClassPtr, 100663377);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleYTimeline>.NativeClassPtr, 100663378);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 840919, RefRangeEnd = 840921, XrefRangeStart = 840913, XrefRangeEnd = 840919, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ScaleYTimeline(int frameCount, int bezierCount, int boneIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ScaleYTimeline>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 840921, XrefRangeEnd = 840922, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ScaleYTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
