...
public class PhysicsConstraintStrengthTimeline : PhysicsConstraintTimeline
{
	...
	static PhysicsConstraintStrengthTimeline()
	{
		Il2CppClassPointerStore<PhysicsConstraintStrengthTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "PhysicsConstraintStrengthTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PhysicsConstraintStrengthTimeline>.NativeClassPtr);
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintStrengthTimeline>.NativeClassPtr, 100663458);
		NativeMethodInfoPtr_Setup_Protected_Virtual_Single_PhysicsConstraint_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintStrengthTimeline>.NativeClassPtr, 100663459);
		NativeMethodInfoPtr_Get_Protected_Virtual_Single_PhysicsConstraint_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintStrengthTimeline>.NativeClassPtr, 100663460);
		NativeMethodInfoPtr_Set_Protected_Virtual_Void_PhysicsConstraint_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintStrengthTimeline>.NativeClassPtr, 100663461);
		NativeMethodInfoPtr_Global_Protected_Virtual_Boolean_PhysicsConstraintData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintStrengthTimeline>.NativeClassPtr, 100663462);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 841350, RefRangeEnd = 841352, XrefRangeStart = 841349, XrefRangeEnd = 841350, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PhysicsConstraintStrengthTimeline(int frameCount, int bezierCount, int physicsConstraintIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PhysicsConstraintStrengthTimeline>.NativeClassPtr))
	{
	...
	public PhysicsConstraintStrengthTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
