...
public class TranslateXTimeline : CurveTimeline1
{
	...
	static TranslateXTimeline()
	{
		Il2CppClassPointerStore<TranslateXTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "TranslateXTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<TranslateXTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_boneIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TranslateXTimeline>.NativeClassPtr, "boneIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TranslateXTimeline>.NativeClassPtr, 100663364);
		NativeMethodInfoPtr_get_BoneIndex_Public_Virtual_Final_New_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TranslateXTimeline>.NativeClassPtr, 100663365);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TranslateXTimeline>.NativeClassPtr, 100663366);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 840874, RefRangeEnd = 840876, XrefRangeStart = 840868, XrefRangeEnd = 840874, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe TranslateXTimeline(int frameCount, int bezierCount, int boneIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TranslateXTimeline>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 840876, XrefRangeEnd = 840877, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public TranslateXTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
