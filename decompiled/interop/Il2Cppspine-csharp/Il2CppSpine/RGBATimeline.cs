...
public class RGBATimeline : CurveTimeline
{
	...
	static RGBATimeline()
	{
		Il2CppClassPointerStore<RGBATimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "RGBATimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<RGBATimeline>.NativeClassPtr);
		NativeFieldInfoPtr_slotIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RGBATimeline>.NativeClassPtr, "slotIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RGBATimeline>.NativeClassPtr, 100663393);
		NativeMethodInfoPtr_get_FrameEntries_Public_Virtual_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RGBATimeline>.NativeClassPtr, 100663394);
		NativeMethodInfoPtr_SetFrame_Public_Void_Int32_Single_Single_Single_Single_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RGBATimeline>.NativeClassPtr, 100663395);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RGBATimeline>.NativeClassPtr, 100663396);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 840994, RefRangeEnd = 840996, XrefRangeStart = 840979, XrefRangeEnd = 840994, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe RGBATimeline(int frameCount, int bezierCount, int slotIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<RGBATimeline>.NativeClassPtr))
	{
	...
	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 840996, RefRangeEnd = 840998, XrefRangeStart = 840996, XrefRangeEnd = 840996, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void SetFrame(int frame, float time, float r, float g, float b, float a)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		...
		*(float**)((byte*)ptr + checked((nuint)5u * unchecked((nuint)sizeof(IntPtr)))) = &a;
		Unsafe.SkipInit(out IntPtr intPtr);
		IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_SetFrame_Public_Void_Int32_Single_Single_Single_Single_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr);
		Il2CppException.RaiseExceptionIfNecessary(intPtr);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 840998, XrefRangeEnd = 841006, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public RGBATimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
