...
public class AlphaTimeline : CurveTimeline1
{
	...
	static AlphaTimeline()
	{
		Il2CppClassPointerStore<AlphaTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "AlphaTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AlphaTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_slotIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AlphaTimeline>.NativeClassPtr, "slotIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AlphaTimeline>.NativeClassPtr, 100663401);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AlphaTimeline>.NativeClassPtr, 100663402);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 841035, RefRangeEnd = 841037, XrefRangeStart = 841029, XrefRangeEnd = 841035, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe AlphaTimeline(int frameCount, int bezierCount, int slotIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AlphaTimeline>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 841037, XrefRangeEnd = 841039, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AlphaTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
