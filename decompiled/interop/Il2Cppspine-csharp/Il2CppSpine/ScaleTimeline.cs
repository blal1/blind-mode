...
public class ScaleTimeline : CurveTimeline2
{
	...
	{
		Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "ScaleTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_boneIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr, "boneIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr, 100663370);
		NativeMethodInfoPtr_get_BoneIndex_Public_Virtual_Final_New_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr, 100663371);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ScaleTimeline>.NativeClassPtr, 100663372);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 840896, RefRangeEnd = 840898, XrefRangeStart = 840886, XrefRangeEnd = 840896, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ScaleTimeline(int frameCount, int bezierCount, int boneIndex)
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 840898, XrefRangeEnd = 840904, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
