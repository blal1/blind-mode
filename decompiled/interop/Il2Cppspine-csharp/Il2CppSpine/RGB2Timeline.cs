...
public class RGB2Timeline : CurveTimeline
{
	...
	static RGB2Timeline()
	{
		Il2CppClassPointerStore<RGB2Timeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "RGB2Timeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<RGB2Timeline>.NativeClassPtr);
		NativeFieldInfoPtr_slotIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RGB2Timeline>.NativeClassPtr, "slotIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RGB2Timeline>.NativeClassPtr, 100663407);
		NativeMethodInfoPtr_get_FrameEntries_Public_Virtual_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RGB2Timeline>.NativeClassPtr, 100663408);
		NativeMethodInfoPtr_SetFrame_Public_Void_Int32_Single_Single_Single_Single_Single_Single_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RGB2Timeline>.NativeClassPtr, 100663409);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RGB2Timeline>.NativeClassPtr, 100663410);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 841090, RefRangeEnd = 841092, XrefRangeStart = 841075, XrefRangeEnd = 841090, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe RGB2Timeline(int frameCount, int bezierCount, int slotIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<RGB2Timeline>.NativeClassPtr))
	{
	...
	[CallerCount(4)]
	[CachedScanResults(RefRangeStart = 841092, RefRangeEnd = 841096, XrefRangeStart = 841092, XrefRangeEnd = 841092, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void SetFrame(int frame, float time, float r, float g, float b, float r2, float g2, float b2)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		...
		*(float**)((byte*)ptr + checked((nuint)5u * unchecked((nuint)sizeof(IntPtr)))) = &r2;
		*(float**)((byte*)ptr + checked((nuint)6u * unchecked((nuint)sizeof(IntPtr)))) = &g2;
		*(float**)((byte*)ptr + checked((nuint)7u * unchecked((nuint)sizeof(IntPtr)))) = &b2;
		Unsafe.SkipInit(out IntPtr intPtr);
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 841096, XrefRangeEnd = 841107, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public RGB2Timeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
