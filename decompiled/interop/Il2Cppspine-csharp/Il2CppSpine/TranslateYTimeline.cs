...
public class TranslateYTimeline : CurveTimeline1
{
	...
	static TranslateYTimeline()
	{
		Il2CppClassPointerStore<TranslateYTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "TranslateYTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<TranslateYTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_boneIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TranslateYTimeline>.NativeClassPtr, "boneIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TranslateYTimeline>.NativeClassPtr, 100663367);
		NativeMethodInfoPtr_get_BoneIndex_Public_Virtual_Final_New_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TranslateYTimeline>.NativeClassPtr, 100663368);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TranslateYTimeline>.NativeClassPtr, 100663369);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 840883, RefRangeEnd = 840885, XrefRangeStart = 840877, XrefRangeEnd = 840883, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe TranslateYTimeline(int frameCount, int bezierCount, int boneIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TranslateYTimeline>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 840885, XrefRangeEnd = 840886, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public TranslateYTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
