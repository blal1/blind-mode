...
public class ShearTimeline : CurveTimeline2
{
	...
	{
		Il2CppClassPointerStore<ShearTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "ShearTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ShearTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_boneIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShearTimeline>.NativeClassPtr, "boneIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShearTimeline>.NativeClassPtr, 100663379);
		NativeMethodInfoPtr_get_BoneIndex_Public_Virtual_Final_New_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShearTimeline>.NativeClassPtr, 100663380);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShearTimeline>.NativeClassPtr, 100663381);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 840932, RefRangeEnd = 840934, XrefRangeStart = 840922, XrefRangeEnd = 840932, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ShearTimeline(int frameCount, int bezierCount, int boneIndex)
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 840934, XrefRangeEnd = 840938, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
