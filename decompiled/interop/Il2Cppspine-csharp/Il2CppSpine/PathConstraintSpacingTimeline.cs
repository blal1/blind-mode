...
public class PathConstraintSpacingTimeline : CurveTimeline1
{
	...
	{
		Il2CppClassPointerStore<PathConstraintSpacingTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "PathConstraintSpacingTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PathConstraintSpacingTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_constraintIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PathConstraintSpacingTimeline>.NativeClassPtr, "constraintIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PathConstraintSpacingTimeline>.NativeClassPtr, 100663441);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PathConstraintSpacingTimeline>.NativeClassPtr, 100663442);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 841312, RefRangeEnd = 841314, XrefRangeStart = 841306, XrefRangeEnd = 841312, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PathConstraintSpacingTimeline(int frameCount, int bezierCount, int pathConstraintIndex)
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 841314, XrefRangeEnd = 841315, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
