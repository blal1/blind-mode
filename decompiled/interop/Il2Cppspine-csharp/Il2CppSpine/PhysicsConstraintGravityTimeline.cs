...
public class PhysicsConstraintGravityTimeline : PhysicsConstraintTimeline
{
	...
	static PhysicsConstraintGravityTimeline()
	{
		Il2CppClassPointerStore<PhysicsConstraintGravityTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "PhysicsConstraintGravityTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PhysicsConstraintGravityTimeline>.NativeClassPtr);
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintGravityTimeline>.NativeClassPtr, 100663478);
		NativeMethodInfoPtr_Setup_Protected_Virtual_Single_PhysicsConstraint_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintGravityTimeline>.NativeClassPtr, 100663479);
		NativeMethodInfoPtr_Get_Protected_Virtual_Single_PhysicsConstraint_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintGravityTimeline>.NativeClassPtr, 100663480);
		NativeMethodInfoPtr_Set_Protected_Virtual_Void_PhysicsConstraint_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintGravityTimeline>.NativeClassPtr, 100663481);
		NativeMethodInfoPtr_Global_Protected_Virtual_Boolean_PhysicsConstraintData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintGravityTimeline>.NativeClassPtr, 100663482);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 841362, RefRangeEnd = 841364, XrefRangeStart = 841361, XrefRangeEnd = 841362, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PhysicsConstraintGravityTimeline(int frameCount, int bezierCount, int physicsConstraintIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PhysicsConstraintGravityTimeline>.NativeClassPtr))
	{
	...
	public PhysicsConstraintGravityTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
