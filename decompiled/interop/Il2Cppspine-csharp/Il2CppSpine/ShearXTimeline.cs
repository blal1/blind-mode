...
public class ShearXTimeline : CurveTimeline1
{
	...
	static ShearXTimeline()
	{
		Il2CppClassPointerStore<ShearXTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "ShearXTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ShearXTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_boneIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShearXTimeline>.NativeClassPtr, "boneIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShearXTimeline>.NativeClassPtr, 100663382);
		NativeMethodInfoPtr_get_BoneIndex_Public_Virtual_Final_New_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShearXTimeline>.NativeClassPtr, 100663383);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShearXTimeline>.NativeClassPtr, 100663384);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 840944, RefRangeEnd = 840946, XrefRangeStart = 840938, XrefRangeEnd = 840944, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ShearXTimeline(int frameCount, int bezierCount, int boneIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ShearXTimeline>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 840946, XrefRangeEnd = 840947, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ShearXTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
