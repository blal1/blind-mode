...
public class ShearYTimeline : CurveTimeline1
{
	...
	static ShearYTimeline()
	{
		Il2CppClassPointerStore<ShearYTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "ShearYTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ShearYTimeline>.NativeClassPtr);
		NativeFieldInfoPtr_boneIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShearYTimeline>.NativeClassPtr, "boneIndex");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShearYTimeline>.NativeClassPtr, 100663385);
		NativeMethodInfoPtr_get_BoneIndex_Public_Virtual_Final_New_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShearYTimeline>.NativeClassPtr, 100663386);
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_Skeleton_Single_Single_ExposedList_1_Event_Single_MixBlend_MixDirection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShearYTimeline>.NativeClassPtr, 100663387);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 840953, RefRangeEnd = 840955, XrefRangeStart = 840947, XrefRangeEnd = 840953, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ShearYTimeline(int frameCount, int bezierCount, int boneIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ShearYTimeline>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 840955, XrefRangeEnd = 840956, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ShearYTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
