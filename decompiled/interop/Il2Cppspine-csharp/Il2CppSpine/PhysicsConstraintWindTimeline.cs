...
public class PhysicsConstraintWindTimeline : PhysicsConstraintTimeline
{
	...
	static PhysicsConstraintWindTimeline()
	{
		Il2CppClassPointerStore<PhysicsConstraintWindTimeline>.NativeClassPtr = IL2CPP.GetIl2CppClass("spine-csharp.dll", "Spine", "PhysicsConstraintWindTimeline");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PhysicsConstraintWindTimeline>.NativeClassPtr);
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintWindTimeline>.NativeClassPtr, 100663473);
		NativeMethodInfoPtr_Setup_Protected_Virtual_Single_PhysicsConstraint_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintWindTimeline>.NativeClassPtr, 100663474);
		NativeMethodInfoPtr_Get_Protected_Virtual_Single_PhysicsConstraint_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintWindTimeline>.NativeClassPtr, 100663475);
		NativeMethodInfoPtr_Set_Protected_Virtual_Void_PhysicsConstraint_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintWindTimeline>.NativeClassPtr, 100663476);
		NativeMethodInfoPtr_Global_Protected_Virtual_Boolean_PhysicsConstraintData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PhysicsConstraintWindTimeline>.NativeClassPtr, 100663477);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 841359, RefRangeEnd = 841361, XrefRangeStart = 841358, XrefRangeEnd = 841359, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PhysicsConstraintWindTimeline(int frameCount, int bezierCount, int physicsConstraintIndex)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PhysicsConstraintWindTimeline>.NativeClassPtr))
	{
	...
	public PhysicsConstraintWindTimeline(IntPtr pointer)
		: base(pointer)
	{
	}
}
