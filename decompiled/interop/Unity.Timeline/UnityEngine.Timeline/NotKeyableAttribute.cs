...
public class NotKeyableAttribute : Il2CppSystem.Attribute
{
	...
	static NotKeyableAttribute()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NotKeyableAttribute>.NativeClassPtr, 100664082);
	}
	...
	public NotKeyableAttribute(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
