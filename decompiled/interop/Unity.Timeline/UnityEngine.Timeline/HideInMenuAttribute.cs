...
public class HideInMenuAttribute : Il2CppSystem.Attribute
{
	...
	static HideInMenuAttribute()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HideInMenuAttribute>.NativeClassPtr, 100664090);
	}
	...
	public HideInMenuAttribute(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
