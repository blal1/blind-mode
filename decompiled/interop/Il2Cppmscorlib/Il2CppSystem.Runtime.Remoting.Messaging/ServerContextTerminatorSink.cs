...
public class ServerContextTerminatorSink : Object
{
	...
	static ServerContextTerminatorSink()
	{
		...
		NativeMethodInfoPtr_SyncProcessMessage_Public_Virtual_Final_New_IMessage_IMessage_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ServerContextTerminatorSink>.NativeClassPtr, 100670529);
		NativeMethodInfoPtr_AsyncProcessMessage_Public_Virtual_Final_New_IMessageCtrl_IMessage_IMessageSink_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ServerContextTerminatorSink>.NativeClassPtr, 100670530);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ServerContextTerminatorSink>.NativeClassPtr, 100670531);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 797151, XrefRangeEnd = 797167, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 797167, XrefRangeEnd = 797175, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ServerContextTerminatorSink(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
