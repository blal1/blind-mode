...
public class ObjRefSurrogate : Object
{
	...
	static ObjRefSurrogate()
	{
		...
		NativeMethodInfoPtr_GetObjectData_Public_Virtual_New_Void_Object_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ObjRefSurrogate>.NativeClassPtr, 100670503);
		NativeMethodInfoPtr_SetObjectData_Public_Virtual_New_Object_Object_SerializationInfo_StreamingContext_ISurrogateSelector_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ObjRefSurrogate>.NativeClassPtr, 100670504);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ObjRefSurrogate>.NativeClassPtr, 100670505);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 797059, XrefRangeEnd = 797070, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 797070, XrefRangeEnd = 797076, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ObjRefSurrogate(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
