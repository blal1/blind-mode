...
public class ClientContextTerminatorSink : Object
{
	...
	private static readonly System.IntPtr NativeMethodInfoPtr__ctor_Public_Void_Context_0;
	...
	static ClientContextTerminatorSink()
	{
		...
		NativeFieldInfoPtr__context = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ClientContextTerminatorSink>.NativeClassPtr, "_context");
		NativeMethodInfoPtr__ctor_Public_Void_Context_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClientContextTerminatorSink>.NativeClassPtr, 100670326);
		NativeMethodInfoPtr_SyncProcessMessage_Public_Virtual_Final_New_IMessage_IMessage_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClientContextTerminatorSink>.NativeClassPtr, 100670327);
		NativeMethodInfoPtr_AsyncProcessMessage_Public_Virtual_Final_New_IMessageCtrl_IMessage_IMessageSink_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClientContextTerminatorSink>.NativeClassPtr, 100670328);
	}
		...
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ClientContextTerminatorSink>.NativeClassPtr))
	{
		...
		*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)ctx);
		...
		System.IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_Context_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr);
		Il2CppException.RaiseExceptionIfNecessary(intPtr);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 795746, XrefRangeEnd = 795770, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 795770, XrefRangeEnd = 795798, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ClientContextTerminatorSink(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
