...
public class IDynamicProperty : Il2CppObjectBase
{
	...
	static IDynamicProperty()
	{
		...
		NativeMethodInfoPtr_get_Name_Public_Abstract_Virtual_New_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<IDynamicProperty>.NativeClassPtr, 100670141);
	}

	public IDynamicProperty(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
