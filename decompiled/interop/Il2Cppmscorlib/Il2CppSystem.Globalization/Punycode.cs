...
public class Punycode : Bootstring
{
	...
	static Punycode()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Punycode>.NativeClassPtr, 100673292);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 821906, XrefRangeEnd = 821907, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public Punycode(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
