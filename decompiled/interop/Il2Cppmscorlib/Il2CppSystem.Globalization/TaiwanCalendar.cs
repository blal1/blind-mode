...
{
	private static readonly System.IntPtr NativeFieldInfoPtr_taiwanEraInfo;
	...
	public unsafe static Il2CppReferenceArray<EraInfo> taiwanEraInfo
	{
		get
		{
			...
			IL2CPP.il2cpp_field_static_get_value(NativeFieldInfoPtr_taiwanEraInfo, (void*)(&intPtr));
			System.IntPtr intPtr2 = intPtr;
			return (intPtr2 != (System.IntPtr)0) ? Il2CppObjectPool.Get<Il2CppReferenceArray<EraInfo>>(intPtr2) : null;
		}
		set
		{
			IL2CPP.il2cpp_field_static_set_value(NativeFieldInfoPtr_taiwanEraInfo, (void*)IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)value));
		}
	}
	...
	{
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 819306, XrefRangeEnd = 819310, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
	...
	{
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 819310, XrefRangeEnd = 819314, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			System.IntPtr* ptr = null;
	...
	public unsafe override int TwoDigitYearMax
	{
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 819340, XrefRangeEnd = 819341, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		set
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
	...
	static TaiwanCalendar()
	{
		...
		NativeFieldInfoPtr_taiwanEraInfo = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, "taiwanEraInfo");
		NativeFieldInfoPtr_s_defaultInstance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, "s_defaultInstance");
		NativeFieldInfoPtr_helper = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, "helper");
		NativeFieldInfoPtr_calendarMinValue = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, "calendarMinValue");
		NativeMethodInfoPtr_GetDefaultInstance_Internal_Static_Calendar_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673020);
		NativeMethodInfoPtr_get_MinSupportedDateTime_Public_Virtual_get_DateTime_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673021);
		NativeMethodInfoPtr_get_MaxSupportedDateTime_Public_Virtual_get_DateTime_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673022);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673023);
		NativeMethodInfoPtr_get_ID_Internal_Virtual_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673024);
		NativeMethodInfoPtr_GetDaysInMonth_Public_Virtual_Int32_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673025);
		NativeMethodInfoPtr_GetDaysInYear_Public_Virtual_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673026);
		NativeMethodInfoPtr_GetDayOfMonth_Public_Virtual_Int32_DateTime_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673027);
		NativeMethodInfoPtr_GetDayOfWeek_Public_Virtual_DayOfWeek_DateTime_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673028);
		NativeMethodInfoPtr_GetMonthsInYear_Public_Virtual_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673029);
		NativeMethodInfoPtr_GetEra_Public_Virtual_Int32_DateTime_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673030);
		NativeMethodInfoPtr_GetMonth_Public_Virtual_Int32_DateTime_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673031);
		NativeMethodInfoPtr_GetYear_Public_Virtual_Int32_DateTime_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673032);
		NativeMethodInfoPtr_IsLeapYear_Public_Virtual_Boolean_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673033);
		NativeMethodInfoPtr_ToDateTime_Public_Virtual_DateTime_Int32_Int32_Int32_Int32_Int32_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673034);
		NativeMethodInfoPtr_get_Eras_Public_Virtual_get_Il2CppStructArray_1_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673035);
		NativeMethodInfoPtr_get_TwoDigitYearMax_Public_Virtual_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673036);
		NativeMethodInfoPtr_set_TwoDigitYearMax_Public_Virtual_set_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673037);
		NativeMethodInfoPtr_ToFourDigitYear_Public_Virtual_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaiwanCalendar>.NativeClassPtr, 100673038);
	}

	[CallerCount(3)]
	[CachedScanResults(RefRangeStart = 819303, RefRangeEnd = 819306, XrefRangeStart = 819285, XrefRangeEnd = 819303, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 819339, RefRangeEnd = 819340, XrefRangeStart = 819314, XrefRangeEnd = 819339, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public TaiwanCalendar(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
