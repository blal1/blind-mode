...
public sealed class SByteEnumEqualityComparer<T> : EnumEqualityComparer<T> where T : new()
{
	...
	{
		Il2CppClassPointerStore<SByteEnumEqualityComparer<T>>.NativeClassPtr = IL2CPP.il2cpp_class_from_type(Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(IL2CPP.GetIl2CppClass("mscorlib.dll", "System.Collections.Generic", "SByteEnumEqualityComparer`1"))).MakeGenericType(new Il2CppReferenceArray<Type>(new Type[1] { Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<T>.NativeClassPtr)) })).TypeHandle.value);
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SByteEnumEqualityComparer<T>>.NativeClassPtr);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SByteEnumEqualityComparer<T>>.NativeClassPtr, 100674311);
		NativeMethodInfoPtr__ctor_Public_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SByteEnumEqualityComparer<T>>.NativeClassPtr, 100674312);
		NativeMethodInfoPtr_GetHashCode_Public_Virtual_Int32_T_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SByteEnumEqualityComparer<T>>.NativeClassPtr, 100674313);
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 833175, XrefRangeEnd = 833178, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public SByteEnumEqualityComparer(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
