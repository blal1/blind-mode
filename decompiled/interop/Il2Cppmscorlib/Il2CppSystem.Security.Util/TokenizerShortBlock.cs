...
public sealed class TokenizerShortBlock : Object
{
	...
	static TokenizerShortBlock()
	{
		...
		NativeFieldInfoPtr_m_block = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TokenizerShortBlock>.NativeClassPtr, "m_block");
		NativeFieldInfoPtr_m_next = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TokenizerShortBlock>.NativeClassPtr, "m_next");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TokenizerShortBlock>.NativeClassPtr, 100669131);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 784001, XrefRangeEnd = 784006, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public TokenizerShortBlock(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
