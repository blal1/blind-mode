...
public class ActivatedServiceTypeEntry : TypeEntry
{
	...
	static ActivatedServiceTypeEntry()
	{
		...
		NativeFieldInfoPtr_obj_type = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ActivatedServiceTypeEntry>.NativeClassPtr, "obj_type");
		NativeMethodInfoPtr__ctor_Public_Void_String_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ActivatedServiceTypeEntry>.NativeClassPtr, 100669783);
		NativeMethodInfoPtr_get_ObjectType_Public_get_Type_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ActivatedServiceTypeEntry>.NativeClassPtr, 100669784);
		NativeMethodInfoPtr_ToString_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ActivatedServiceTypeEntry>.NativeClassPtr, 100669785);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 789726, XrefRangeEnd = 789734, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 789734, XrefRangeEnd = 789735, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ActivatedServiceTypeEntry(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
