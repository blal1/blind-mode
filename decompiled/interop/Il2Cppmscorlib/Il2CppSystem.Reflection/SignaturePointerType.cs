...
public sealed class SignaturePointerType : SignatureHasElementType
{
	...
	{
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 809138, XrefRangeEnd = 809140, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			System.IntPtr* ptr = null;
	...
	static SignaturePointerType()
	{
		...
		NativeMethodInfoPtr__ctor_Internal_Void_SignatureType_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SignaturePointerType>.NativeClassPtr, 100671923);
		NativeMethodInfoPtr_IsArrayImpl_Protected_Virtual_Final_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SignaturePointerType>.NativeClassPtr, 100671924);
		NativeMethodInfoPtr_IsByRefImpl_Protected_Virtual_Final_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SignaturePointerType>.NativeClassPtr, 100671925);
		NativeMethodInfoPtr_IsPointerImpl_Protected_Virtual_Final_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SignaturePointerType>.NativeClassPtr, 100671926);
		NativeMethodInfoPtr_get_IsSZArray_Public_Virtual_Final_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SignaturePointerType>.NativeClassPtr, 100671927);
		NativeMethodInfoPtr_get_IsVariableBoundArray_Public_Virtual_Final_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SignaturePointerType>.NativeClassPtr, 100671928);
		NativeMethodInfoPtr_GetArrayRank_Public_Virtual_Final_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SignaturePointerType>.NativeClassPtr, 100671929);
		NativeMethodInfoPtr_get_Suffix_Protected_Virtual_Final_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SignaturePointerType>.NativeClassPtr, 100671930);
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 809132, XrefRangeEnd = 809138, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public SignaturePointerType(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
