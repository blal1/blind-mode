...
public sealed class WaitCallback : MulticastDelegate
{
	...
	static WaitCallback()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitCallback>.NativeClassPtr, 100667935);
		NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitCallback>.NativeClassPtr, 100667936);
	}
	...
	public unsafe WaitCallback(Object @object, System.IntPtr method)
	...
	public WaitCallback(System.IntPtr pointer)
		: base(pointer)
	{
	}

	public static implicit operator WaitCallback(System.Action<Object> P_0)
	{
		return DelegateSupport.ConvertDelegate<WaitCallback>((System.Delegate)P_0);
	}

	public static WaitCallback operator +(WaitCallback P_0, WaitCallback P_1)
	{
		return ((Il2CppObjectBase)Delegate.Combine(P_0, P_1)).Cast<WaitCallback>();
	}
	...
	public static WaitCallback operator -(WaitCallback P_0, WaitCallback P_1)
	{
		...
		if (obj != null)
		{
			obj = ((Il2CppObjectBase)obj).Cast<WaitCallback>();
		}
		return (WaitCallback)obj;
	}
}
