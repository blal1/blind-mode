...
public sealed class SendOrPostCallback : MulticastDelegate
{
	...
	static SendOrPostCallback()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SendOrPostCallback>.NativeClassPtr, 100667570);
		NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SendOrPostCallback>.NativeClassPtr, 100667571);
	}
	...
	public unsafe SendOrPostCallback(Object @object, System.IntPtr method)
	...
	public SendOrPostCallback(System.IntPtr pointer)
		: base(pointer)
	{
	}

	public static implicit operator SendOrPostCallback(System.Action<Object> P_0)
	{
		return DelegateSupport.ConvertDelegate<SendOrPostCallback>((System.Delegate)P_0);
	}

	public static SendOrPostCallback operator +(SendOrPostCallback P_0, SendOrPostCallback P_1)
	{
		return ((Il2CppObjectBase)Delegate.Combine(P_0, P_1)).Cast<SendOrPostCallback>();
	}
	...
	public static SendOrPostCallback operator -(SendOrPostCallback P_0, SendOrPostCallback P_1)
	{
		...
		if (obj != null)
		{
			obj = ((Il2CppObjectBase)obj).Cast<SendOrPostCallback>();
		}
		return (SendOrPostCallback)obj;
	}
}
