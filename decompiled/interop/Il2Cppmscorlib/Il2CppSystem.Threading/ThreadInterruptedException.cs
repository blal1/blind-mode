...
public class ThreadInterruptedException : SystemException
{
	...
	static ThreadInterruptedException()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ThreadInterruptedException>.NativeClassPtr, 100667931);
		NativeMethodInfoPtr__ctor_Protected_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ThreadInterruptedException>.NativeClassPtr, 100667932);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 771134, XrefRangeEnd = 771162, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ThreadInterruptedException(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
