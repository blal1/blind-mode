...
public sealed class TimerCallback : MulticastDelegate
{
	...
	static TimerCallback()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TimerCallback>.NativeClassPtr, 100668087);
		NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TimerCallback>.NativeClassPtr, 100668088);
	}
	...
	public unsafe TimerCallback(Object @object, System.IntPtr method)
	...
	public TimerCallback(System.IntPtr pointer)
		: base(pointer)
	{
	}

	public static implicit operator TimerCallback(System.Action<Object> P_0)
	{
		return DelegateSupport.ConvertDelegate<TimerCallback>((System.Delegate)P_0);
	}

	public static TimerCallback operator +(TimerCallback P_0, TimerCallback P_1)
	{
		return ((Il2CppObjectBase)Delegate.Combine(P_0, P_1)).Cast<TimerCallback>();
	}
	...
	public static TimerCallback operator -(TimerCallback P_0, TimerCallback P_1)
	{
		...
		if (obj != null)
		{
			obj = ((Il2CppObjectBase)obj).Cast<TimerCallback>();
		}
		return (TimerCallback)obj;
	}
}
