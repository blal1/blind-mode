...
public class MissingManifestResourceException : SystemException
{
	...
	static MissingManifestResourceException()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MissingManifestResourceException>.NativeClassPtr, 100671560);
		NativeMethodInfoPtr__ctor_Protected_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MissingManifestResourceException>.NativeClassPtr, 100671561);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 807492, XrefRangeEnd = 807495, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public MissingManifestResourceException(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
