...
public sealed class InvalidProgramException : SystemException
{
	...
	static InvalidProgramException()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvalidProgramException>.NativeClassPtr, 100665314);
		NativeMethodInfoPtr__ctor_Public_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvalidProgramException>.NativeClassPtr, 100665315);
		NativeMethodInfoPtr__ctor_Internal_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvalidProgramException>.NativeClassPtr, 100665316);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 731446, XrefRangeEnd = 731449, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 731449, XrefRangeEnd = 731450, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public InvalidProgramException(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
