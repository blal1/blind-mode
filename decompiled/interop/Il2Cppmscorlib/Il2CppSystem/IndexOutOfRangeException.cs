...
public sealed class IndexOutOfRangeException : SystemException
{
	...
	static IndexOutOfRangeException()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<IndexOutOfRangeException>.NativeClassPtr, 100665206);
		NativeMethodInfoPtr__ctor_Public_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<IndexOutOfRangeException>.NativeClassPtr, 100665207);
		NativeMethodInfoPtr__ctor_Internal_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<IndexOutOfRangeException>.NativeClassPtr, 100665208);
	}

	[CallerCount(8)]
	[CachedScanResults(RefRangeStart = 728423, RefRangeEnd = 728431, XrefRangeStart = 728420, XrefRangeEnd = 728423, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(13)]
	[CachedScanResults(RefRangeStart = 728432, RefRangeEnd = 728445, XrefRangeStart = 728431, XrefRangeEnd = 728432, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public IndexOutOfRangeException(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
