...
public sealed class MulticastNotSupportedException : SystemException
{
	...
	static MulticastNotSupportedException()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MulticastNotSupportedException>.NativeClassPtr, 100665445);
		NativeMethodInfoPtr__ctor_Public_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MulticastNotSupportedException>.NativeClassPtr, 100665446);
		NativeMethodInfoPtr__ctor_Internal_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MulticastNotSupportedException>.NativeClassPtr, 100665447);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 732896, XrefRangeEnd = 732899, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 732900, RefRangeEnd = 732901, XrefRangeStart = 732899, XrefRangeEnd = 732900, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public MulticastNotSupportedException(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
