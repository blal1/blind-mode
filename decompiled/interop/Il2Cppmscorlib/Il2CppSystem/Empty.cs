...
public sealed class Empty : Object
{
	...
	public unsafe static Empty Value
	{
		get
		{
			...
			return (intPtr2 != (System.IntPtr)0) ? Il2CppObjectPool.Get<Empty>(intPtr2) : null;
		}
		set
		{
	...
	static Empty()
	{
		...
		NativeFieldInfoPtr_Value = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Empty>.NativeClassPtr, "Value");
		NativeMethodInfoPtr__ctor_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Empty>.NativeClassPtr, 100666680);
		NativeMethodInfoPtr_ToString_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Empty>.NativeClassPtr, 100666681);
		NativeMethodInfoPtr_GetObjectData_Public_Virtual_Final_New_Void_SerializationInfo_StreamingContext_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Empty>.NativeClassPtr, 100666682);
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 754727, XrefRangeEnd = 754728, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public Empty(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
