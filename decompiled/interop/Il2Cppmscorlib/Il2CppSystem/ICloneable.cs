...
public class ICloneable : Il2CppObjectBase
{
	...
	static ICloneable()
	{
		...
		NativeMethodInfoPtr_Clone_Public_Abstract_Virtual_New_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ICloneable>.NativeClassPtr, 100665176);
	}
	...
	public ICloneable(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
