...
public class ContextBoundObject : MarshalByRefObject
{
	...
	static ContextBoundObject()
	{
		...
		NativeMethodInfoPtr__ctor_Protected_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ContextBoundObject>.NativeClassPtr, 100666649);
	}
	...
	public ContextBoundObject(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
