...
public class RSAPKCS1SHA1SignatureDescription : RSAPKCS1SignatureDescription
{
	...
	static RSAPKCS1SHA1SignatureDescription()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RSAPKCS1SHA1SignatureDescription>.NativeClassPtr, 100669499);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 787117, XrefRangeEnd = 787122, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public RSAPKCS1SHA1SignatureDescription(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
