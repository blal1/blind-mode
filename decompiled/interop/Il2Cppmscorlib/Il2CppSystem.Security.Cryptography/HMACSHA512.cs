...
public class HMACSHA512 : HMAC
{
	...
	static HMACSHA512()
	{
		...
		NativeFieldInfoPtr_m_useLegacyBlockSize = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<HMACSHA512>.NativeClassPtr, "m_useLegacyBlockSize");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HMACSHA512>.NativeClassPtr, 100669307);
		NativeMethodInfoPtr__ctor_Public_Void_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HMACSHA512>.NativeClassPtr, 100669308);
		NativeMethodInfoPtr_get_BlockSize_Private_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HMACSHA512>.NativeClassPtr, 100669309);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 785687, XrefRangeEnd = 785704, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 785704, XrefRangeEnd = 785720, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public HMACSHA512(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
