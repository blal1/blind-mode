...
public class RSAPKCS1SHA384SignatureDescription : RSAPKCS1SignatureDescription
{
	...
	static RSAPKCS1SHA384SignatureDescription()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RSAPKCS1SHA384SignatureDescription>.NativeClassPtr, 100669501);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 787127, XrefRangeEnd = 787132, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public RSAPKCS1SHA384SignatureDescription(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
