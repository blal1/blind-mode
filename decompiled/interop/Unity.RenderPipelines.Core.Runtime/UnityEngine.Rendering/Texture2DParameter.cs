...
public class Texture2DParameter : VolumeParameter<Texture>
{
	...
	static Texture2DParameter()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_Texture_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Texture2DParameter>.NativeClassPtr, 100666996);
		NativeMethodInfoPtr_GetHashCode_Public_Virtual_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Texture2DParameter>.NativeClassPtr, 100666997);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1054784, XrefRangeEnd = 1054787, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1054787, XrefRangeEnd = 1054798, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
