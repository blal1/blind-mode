...
public class Vector3Parameter : VolumeParameter<Vector3>
{
	...
	static Vector3Parameter()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_Vector3_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Vector3Parameter>.NativeClassPtr, 100666985);
		NativeMethodInfoPtr_Interp_Public_Virtual_Void_Vector3_Vector3_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Vector3Parameter>.NativeClassPtr, 100666986);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 1054734, RefRangeEnd = 1054735, XrefRangeStart = 1054731, XrefRangeEnd = 1054734, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe override void Interp(Vector3 from, Vector3 to, float t)
	{
		...
		*ptr = (nint)(&from);
		*(Vector3**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &to;
		*(float**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &t;
		Unsafe.SkipInit(out IntPtr intPtr);
		IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(IL2CPP.il2cpp_object_get_virtual_method(IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)this), NativeMethodInfoPtr_Interp_Public_Virtual_Void_Vector3_Vector3_Single_0), IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr);
		Il2CppException.RaiseExceptionIfNecessary(intPtr);
	}
