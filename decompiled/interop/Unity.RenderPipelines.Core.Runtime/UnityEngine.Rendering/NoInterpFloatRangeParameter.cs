...
public class NoInterpFloatRangeParameter : VolumeParameter<Vector2>
{
	...
	static NoInterpFloatRangeParameter()
	{
		...
		NativeFieldInfoPtr_min = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NoInterpFloatRangeParameter>.NativeClassPtr, "min");
		NativeFieldInfoPtr_max = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NoInterpFloatRangeParameter>.NativeClassPtr, "max");
		NativeMethodInfoPtr_get_value_Public_Virtual_get_Vector2_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NoInterpFloatRangeParameter>.NativeClassPtr, 100666974);
		NativeMethodInfoPtr_set_value_Public_Virtual_set_Void_Vector2_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NoInterpFloatRangeParameter>.NativeClassPtr, 100666975);
		NativeMethodInfoPtr__ctor_Public_Void_Vector2_Single_Single_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NoInterpFloatRangeParameter>.NativeClassPtr, 100666976);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1054701, XrefRangeEnd = 1054704, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
