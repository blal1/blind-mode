...
public class NoInterpMinIntParameter : VolumeParameter<int>
{
	...
	static NoInterpMinIntParameter()
	{
		...
		NativeFieldInfoPtr_min = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NoInterpMinIntParameter>.NativeClassPtr, "min");
		NativeMethodInfoPtr_get_value_Public_Virtual_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NoInterpMinIntParameter>.NativeClassPtr, 100666934);
		NativeMethodInfoPtr_set_value_Public_Virtual_set_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NoInterpMinIntParameter>.NativeClassPtr, 100666935);
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NoInterpMinIntParameter>.NativeClassPtr, 100666936);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1054590, XrefRangeEnd = 1054593, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
