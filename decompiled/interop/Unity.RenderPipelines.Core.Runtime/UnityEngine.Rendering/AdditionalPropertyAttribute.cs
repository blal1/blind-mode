...
public class AdditionalPropertyAttribute : Il2CppSystem.Attribute
{
	...
	static AdditionalPropertyAttribute()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AdditionalPropertyAttribute>.NativeClassPtr, 100664321);
	}
	...
	public AdditionalPropertyAttribute(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
