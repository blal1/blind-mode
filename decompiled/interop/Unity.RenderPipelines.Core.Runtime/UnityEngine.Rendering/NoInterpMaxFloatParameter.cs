...
public class NoInterpMaxFloatParameter : VolumeParameter<float>
{
	...
	static NoInterpMaxFloatParameter()
	{
		...
		NativeFieldInfoPtr_max = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NoInterpMaxFloatParameter>.NativeClassPtr, "max");
		NativeMethodInfoPtr_get_value_Public_Virtual_get_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NoInterpMaxFloatParameter>.NativeClassPtr, 100666961);
		NativeMethodInfoPtr_set_value_Public_Virtual_set_Void_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NoInterpMaxFloatParameter>.NativeClassPtr, 100666962);
		NativeMethodInfoPtr__ctor_Public_Void_Single_Single_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NoInterpMaxFloatParameter>.NativeClassPtr, 100666963);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1054637, XrefRangeEnd = 1054640, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
