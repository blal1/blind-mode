...
public sealed class ReloadGroupAttribute : Il2CppSystem.Attribute
{
	...
	static ReloadGroupAttribute()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReloadGroupAttribute>.NativeClassPtr, 100664545);
	}
	...
	public ReloadGroupAttribute(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
