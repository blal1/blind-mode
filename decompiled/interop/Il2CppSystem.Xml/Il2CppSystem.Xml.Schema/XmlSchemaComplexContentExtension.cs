...
public class XmlSchemaComplexContentExtension : XmlSchemaContent
{
	...
	public unsafe XmlQualifiedName BaseTypeName
	{
		...
		[CallerCount(1)]
		[CachedScanResults(RefRangeStart = 939096, RefRangeEnd = 939097, XrefRangeStart = 939087, XrefRangeEnd = 939096, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		set
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
	...
	static XmlSchemaComplexContentExtension()
	{
		...
		NativeFieldInfoPtr_particle = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, "particle");
		NativeFieldInfoPtr_attributes = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, "attributes");
		NativeFieldInfoPtr_anyAttribute = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, "anyAttribute");
		NativeFieldInfoPtr_baseTypeName = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, "baseTypeName");
		NativeMethodInfoPtr_get_BaseTypeName_Public_get_XmlQualifiedName_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, 100667475);
		NativeMethodInfoPtr_set_BaseTypeName_Public_set_Void_XmlQualifiedName_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, 100667476);
		NativeMethodInfoPtr_get_Particle_Public_get_XmlSchemaParticle_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, 100667477);
		NativeMethodInfoPtr_set_Particle_Public_set_Void_XmlSchemaParticle_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, 100667478);
		NativeMethodInfoPtr_get_Attributes_Public_get_XmlSchemaObjectCollection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, 100667479);
		NativeMethodInfoPtr_get_AnyAttribute_Public_get_XmlSchemaAnyAttribute_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, 100667480);
		NativeMethodInfoPtr_set_AnyAttribute_Public_set_Void_XmlSchemaAnyAttribute_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, 100667481);
		NativeMethodInfoPtr_SetAttributes_Internal_Void_XmlSchemaObjectCollection_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, 100667482);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaComplexContentExtension>.NativeClassPtr, 100667483);
	}
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 939108, RefRangeEnd = 939109, XrefRangeStart = 939097, XrefRangeEnd = 939108, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public XmlSchemaComplexContentExtension(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
