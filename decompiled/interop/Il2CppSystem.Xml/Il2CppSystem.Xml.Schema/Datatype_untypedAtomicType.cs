...
public class Datatype_untypedAtomicType : Datatype_anyAtomicType
{
	...
	static Datatype_untypedAtomicType()
	{
		...
		NativeMethodInfoPtr_CreateValueConverter_Internal_Virtual_XmlValueConverter_XmlSchemaType_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_untypedAtomicType>.NativeClassPtr, 100666241);
		NativeMethodInfoPtr_get_BuiltInWhitespaceFacet_Internal_Virtual_get_XmlSchemaWhiteSpace_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_untypedAtomicType>.NativeClassPtr, 100666242);
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_untypedAtomicType>.NativeClassPtr, 100666243);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_untypedAtomicType>.NativeClassPtr, 100666244);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 923217, XrefRangeEnd = 923221, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public Datatype_untypedAtomicType(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
