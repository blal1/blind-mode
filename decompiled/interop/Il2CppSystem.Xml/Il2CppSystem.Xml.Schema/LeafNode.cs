...
public class LeafNode : SyntaxTreeNode
{
	...
	static LeafNode()
	{
		...
		NativeFieldInfoPtr_pos = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LeafNode>.NativeClassPtr, "pos");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LeafNode>.NativeClassPtr, 100666034);
		NativeMethodInfoPtr_get_Pos_Public_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LeafNode>.NativeClassPtr, 100666035);
		NativeMethodInfoPtr_set_Pos_Public_set_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LeafNode>.NativeClassPtr, 100666036);
		NativeMethodInfoPtr_ExpandTree_Public_Virtual_Void_InteriorNode_SymbolsDictionary_Positions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LeafNode>.NativeClassPtr, 100666037);
		NativeMethodInfoPtr_ConstructPos_Public_Virtual_Void_BitSet_BitSet_Il2CppReferenceArray_1_BitSet_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LeafNode>.NativeClassPtr, 100666038);
		NativeMethodInfoPtr_get_IsNullable_Public_Virtual_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LeafNode>.NativeClassPtr, 100666039);
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 921514, XrefRangeEnd = 921516, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public LeafNode(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
