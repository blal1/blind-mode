...
public class Datatype_IDREF : Datatype_NCName
{
	...
	static Datatype_IDREF()
	{
		...
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_IDREF>.NativeClassPtr, 100666414);
		NativeMethodInfoPtr_get_TokenizedType_Public_Virtual_get_XmlTokenizedType_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_IDREF>.NativeClassPtr, 100666415);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_IDREF>.NativeClassPtr, 100666416);
	}
	...
	public Datatype_IDREF(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
