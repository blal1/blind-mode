...
public class Datatype_nonNegativeInteger : Datatype_integer
{
	...
	{
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 924042, XrefRangeEnd = 924046, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
	...
	static Datatype_nonNegativeInteger()
	{
		...
		NativeFieldInfoPtr_numeric10FacetsChecker = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Datatype_nonNegativeInteger>.NativeClassPtr, "numeric10FacetsChecker");
		NativeMethodInfoPtr_get_FacetsChecker_Internal_Virtual_get_FacetsChecker_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_nonNegativeInteger>.NativeClassPtr, 100666477);
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_nonNegativeInteger>.NativeClassPtr, 100666478);
		NativeMethodInfoPtr_get_HasValueFacets_Internal_Virtual_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_nonNegativeInteger>.NativeClassPtr, 100666479);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_nonNegativeInteger>.NativeClassPtr, 100666480);
	}
	...
	public Datatype_nonNegativeInteger(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
