...
public class Datatype_ID : Datatype_NCName
{
	...
	static Datatype_ID()
	{
		...
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_ID>.NativeClassPtr, 100666411);
		NativeMethodInfoPtr_get_TokenizedType_Public_Virtual_get_XmlTokenizedType_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_ID>.NativeClassPtr, 100666412);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_ID>.NativeClassPtr, 100666413);
	}
	...
	public Datatype_ID(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
