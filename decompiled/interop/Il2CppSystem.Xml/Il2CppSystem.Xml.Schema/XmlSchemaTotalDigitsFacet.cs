...
public class XmlSchemaTotalDigitsFacet : XmlSchemaNumericFacet
{
	...
	static XmlSchemaTotalDigitsFacet()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaTotalDigitsFacet>.NativeClassPtr, 100667675);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 940068, RefRangeEnd = 940069, XrefRangeStart = 940067, XrefRangeEnd = 940068, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public XmlSchemaTotalDigitsFacet(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
