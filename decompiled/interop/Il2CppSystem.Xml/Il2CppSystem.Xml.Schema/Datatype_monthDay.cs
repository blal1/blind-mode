...
public class Datatype_monthDay : Datatype_dateTimeBase
{
	...
	static Datatype_monthDay()
	{
		...
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_monthDay>.NativeClassPtr, 100666338);
		NativeMethodInfoPtr__ctor_Internal_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_monthDay>.NativeClassPtr, 100666339);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 923617, XrefRangeEnd = 923621, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public Datatype_monthDay(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
