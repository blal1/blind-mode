...
public class Datatype_tokenV1Compat : Datatype_normalizedStringV1Compat
{
	...
	static Datatype_tokenV1Compat()
	{
		...
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_tokenV1Compat>.NativeClassPtr, 100666399);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_tokenV1Compat>.NativeClassPtr, 100666400);
	}
	...
	public Datatype_tokenV1Compat(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
