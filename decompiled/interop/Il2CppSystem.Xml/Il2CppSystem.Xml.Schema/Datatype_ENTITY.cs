...
public class Datatype_ENTITY : Datatype_NCName
{
	...
	static Datatype_ENTITY()
	{
		...
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_ENTITY>.NativeClassPtr, 100666417);
		NativeMethodInfoPtr_get_TokenizedType_Public_Virtual_get_XmlTokenizedType_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_ENTITY>.NativeClassPtr, 100666418);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_ENTITY>.NativeClassPtr, 100666419);
	}
	...
	public Datatype_ENTITY(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
