...
public class Datatype_day : Datatype_dateTimeBase
{
	...
	static Datatype_day()
	{
		...
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_day>.NativeClassPtr, 100666340);
		NativeMethodInfoPtr__ctor_Internal_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_day>.NativeClassPtr, 100666341);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 923621, XrefRangeEnd = 923625, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public Datatype_day(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
