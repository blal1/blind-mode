...
public class Datatype_NMTOKEN : Datatype_token
{
	...
	static Datatype_NMTOKEN()
	{
		...
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_NMTOKEN>.NativeClassPtr, 100666403);
		NativeMethodInfoPtr_get_TokenizedType_Public_Virtual_get_XmlTokenizedType_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_NMTOKEN>.NativeClassPtr, 100666404);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_NMTOKEN>.NativeClassPtr, 100666405);
	}
	...
	public Datatype_NMTOKEN(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
