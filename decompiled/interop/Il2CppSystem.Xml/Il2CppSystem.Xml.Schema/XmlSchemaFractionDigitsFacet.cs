...
public class XmlSchemaFractionDigitsFacet : XmlSchemaNumericFacet
{
	...
	static XmlSchemaFractionDigitsFacet()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaFractionDigitsFacet>.NativeClassPtr, 100667676);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 940070, RefRangeEnd = 940071, XrefRangeStart = 940069, XrefRangeEnd = 940070, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public XmlSchemaFractionDigitsFacet(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
