...
public class XmlSchemaKey : XmlSchemaIdentityConstraint
{
	...
	static XmlSchemaKey()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaKey>.NativeClassPtr, 100667720);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 940143, RefRangeEnd = 940145, XrefRangeStart = 940143, XrefRangeEnd = 940145, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public XmlSchemaKey(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
