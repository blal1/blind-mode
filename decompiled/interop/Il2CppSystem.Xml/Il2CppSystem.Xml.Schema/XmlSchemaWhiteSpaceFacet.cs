...
public class XmlSchemaWhiteSpaceFacet : XmlSchemaFacet
{
	...
	static XmlSchemaWhiteSpaceFacet()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaWhiteSpaceFacet>.NativeClassPtr, 100667677);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 940072, RefRangeEnd = 940073, XrefRangeStart = 940071, XrefRangeEnd = 940072, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public XmlSchemaWhiteSpaceFacet(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
