...
public class Datatype_timeNoTimeZone : Datatype_dateTimeBase
{
	...
	static Datatype_timeNoTimeZone()
	{
		...
		NativeMethodInfoPtr__ctor_Internal_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_timeNoTimeZone>.NativeClassPtr, 100666328);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 923593, XrefRangeEnd = 923597, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public Datatype_timeNoTimeZone(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
