...
public class Datatype_Name : Datatype_token
{
	...
	static Datatype_Name()
	{
		...
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_Name>.NativeClassPtr, 100666406);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_Name>.NativeClassPtr, 100666407);
	}
	...
	public Datatype_Name(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
