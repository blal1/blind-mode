...
public class XmlSchemaMinInclusiveFacet : XmlSchemaFacet
{
	...
	static XmlSchemaMinInclusiveFacet()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<XmlSchemaMinInclusiveFacet>.NativeClassPtr, 100667672);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 940062, RefRangeEnd = 940063, XrefRangeStart = 940061, XrefRangeEnd = 940062, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public XmlSchemaMinInclusiveFacet(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
