...
public class UnionFacetsChecker : FacetsChecker
{
	...
	static UnionFacetsChecker()
	{
		...
		NativeMethodInfoPtr_CheckValueFacets_Internal_Virtual_Exception_Object_XmlSchemaDatatype_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnionFacetsChecker>.NativeClassPtr, 100666668);
		NativeMethodInfoPtr_MatchEnumeration_Internal_Virtual_Boolean_Object_ArrayList_XmlSchemaDatatype_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnionFacetsChecker>.NativeClassPtr, 100666669);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnionFacetsChecker>.NativeClassPtr, 100666670);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 925585, XrefRangeEnd = 925592, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public UnionFacetsChecker(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
