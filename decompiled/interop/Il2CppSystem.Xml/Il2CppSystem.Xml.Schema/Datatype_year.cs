...
public class Datatype_year : Datatype_dateTimeBase
{
	...
	static Datatype_year()
	{
		...
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_year>.NativeClassPtr, 100666336);
		NativeMethodInfoPtr__ctor_Internal_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_year>.NativeClassPtr, 100666337);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 923613, XrefRangeEnd = 923617, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public Datatype_year(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
