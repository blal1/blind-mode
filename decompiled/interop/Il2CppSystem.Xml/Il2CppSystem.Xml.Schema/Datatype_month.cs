...
public class Datatype_month : Datatype_dateTimeBase
{
	...
	static Datatype_month()
	{
		...
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_month>.NativeClassPtr, 100666342);
		NativeMethodInfoPtr__ctor_Internal_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_month>.NativeClassPtr, 100666343);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 923625, XrefRangeEnd = 923642, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public Datatype_month(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
