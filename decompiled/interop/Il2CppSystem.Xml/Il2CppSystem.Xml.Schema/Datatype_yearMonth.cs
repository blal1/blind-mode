...
public class Datatype_yearMonth : Datatype_dateTimeBase
{
	...
	static Datatype_yearMonth()
	{
		...
		NativeMethodInfoPtr_get_TypeCode_Public_Virtual_get_XmlTypeCode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_yearMonth>.NativeClassPtr, 100666334);
		NativeMethodInfoPtr__ctor_Internal_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Datatype_yearMonth>.NativeClassPtr, 100666335);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 923609, XrefRangeEnd = 923613, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public Datatype_yearMonth(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
