...
public class OculusHMDExtended : OculusHMD
{
	...
	static OculusHMDExtended()
	{
		Il2CppClassPointerStore<OculusHMDExtended>.NativeClassPtr = IL2CPP.GetIl2CppClass("Unity.InputSystem.dll", "Unity.XR.Oculus.Input", "OculusHMDExtended");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<OculusHMDExtended>.NativeClassPtr);
		NativeFieldInfoPtr__back_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OculusHMDExtended>.NativeClassPtr, "<back>k__BackingField");
		NativeFieldInfoPtr__touchpad_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OculusHMDExtended>.NativeClassPtr, "<touchpad>k__BackingField");
		NativeMethodInfoPtr_get_back_Public_get_ButtonControl_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OculusHMDExtended>.NativeClassPtr, 100663485);
		NativeMethodInfoPtr_set_back_Protected_set_Void_ButtonControl_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OculusHMDExtended>.NativeClassPtr, 100663486);
		NativeMethodInfoPtr_get_touchpad_Public_get_Vector2Control_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OculusHMDExtended>.NativeClassPtr, 100663487);
		NativeMethodInfoPtr_set_touchpad_Protected_set_Void_Vector2Control_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OculusHMDExtended>.NativeClassPtr, 100663488);
		NativeMethodInfoPtr_FinishSetup_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OculusHMDExtended>.NativeClassPtr, 100663489);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OculusHMDExtended>.NativeClassPtr, 100663490);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 963314, XrefRangeEnd = 963327, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe OculusHMDExtended()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<OculusHMDExtended>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr);
	...
	public OculusHMDExtended(IntPtr pointer)
		: base(pointer)
	{
	}
}
