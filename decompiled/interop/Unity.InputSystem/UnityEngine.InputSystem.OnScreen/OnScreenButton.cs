...
public class OnScreenButton : OnScreenControl
{
	...
	static OnScreenButton()
	{
		Il2CppClassPointerStore<OnScreenButton>.NativeClassPtr = IL2CPP.GetIl2CppClass("Unity.InputSystem.dll", "UnityEngine.InputSystem.OnScreen", "OnScreenButton");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<OnScreenButton>.NativeClassPtr);
		NativeFieldInfoPtr_m_ControlPath = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OnScreenButton>.NativeClassPtr, "m_ControlPath");
		NativeMethodInfoPtr_OnPointerUp_Public_Virtual_Final_New_Void_PointerEventData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnScreenButton>.NativeClassPtr, 100666957);
		NativeMethodInfoPtr_OnPointerDown_Public_Virtual_Final_New_Void_PointerEventData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnScreenButton>.NativeClassPtr, 100666958);
		NativeMethodInfoPtr_get_controlPathInternal_Protected_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnScreenButton>.NativeClassPtr, 100666959);
		NativeMethodInfoPtr_set_controlPathInternal_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnScreenButton>.NativeClassPtr, 100666960);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnScreenButton>.NativeClassPtr, 100666961);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1004558, XrefRangeEnd = 1004561, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1004561, XrefRangeEnd = 1004564, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe OnScreenButton()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<OnScreenButton>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr);
	...
	public OnScreenButton(IntPtr pointer)
		: base(pointer)
	{
	}
}
