...
public class HololensHand : XRController
{
	...
	private static readonly IntPtr NativeFieldInfoPtr__airTap_k__BackingField;
	...
	private static readonly IntPtr NativeMethodInfoPtr_get_airTap_Public_get_ButtonControl_0;

	private static readonly IntPtr NativeMethodInfoPtr_set_airTap_Protected_set_Void_ButtonControl_0;
	...
	public unsafe ButtonControl _airTap_k__BackingField
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr__airTap_k__BackingField);
			IntPtr intPtr = *(IntPtr*)num;
		...
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr__airTap_k__BackingField)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)value));
		}
	}
	...
	public unsafe ButtonControl airTap
	{
		[CallerCount(0)]
		get
		{
			...
			IntPtr* ptr = null;
			Unsafe.SkipInit(out IntPtr intPtr);
			IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_get_airTap_Public_get_ButtonControl_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr);
			Il2CppException.RaiseExceptionIfNecessary(intPtr);
		...
		set
		{
			...
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)value);
			Unsafe.SkipInit(out IntPtr intPtr);
			IntPtr intPtr2 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_set_airTap_Protected_set_Void_ButtonControl_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr);
			Il2CppException.RaiseExceptionIfNecessary(intPtr);
		}
	}
	...
	static HololensHand()
	{
		Il2CppClassPointerStore<HololensHand>.NativeClassPtr = IL2CPP.GetIl2CppClass("Unity.InputSystem.dll", "UnityEngine.XR.WindowsMR.Input", "HololensHand");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<HololensHand>.NativeClassPtr);
		NativeFieldInfoPtr__deviceVelocity_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, "<deviceVelocity>k__BackingField");
		NativeFieldInfoPtr__airTap_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, "<airTap>k__BackingField");
		NativeFieldInfoPtr__sourceLossRisk_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, "<sourceLossRisk>k__BackingField");
		NativeFieldInfoPtr__sourceLossMitigationDirection_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, "<sourceLossMitigationDirection>k__BackingField");
		NativeMethodInfoPtr_get_deviceVelocity_Public_get_Vector3Control_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, 100663540);
		NativeMethodInfoPtr_set_deviceVelocity_Protected_set_Void_Vector3Control_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, 100663541);
		NativeMethodInfoPtr_get_airTap_Public_get_ButtonControl_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, 100663542);
		NativeMethodInfoPtr_set_airTap_Protected_set_Void_ButtonControl_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, 100663543);
		NativeMethodInfoPtr_get_sourceLossRisk_Public_get_AxisControl_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, 100663544);
		NativeMethodInfoPtr_set_sourceLossRisk_Protected_set_Void_AxisControl_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, 100663545);
		NativeMethodInfoPtr_get_sourceLossMitigationDirection_Public_get_Vector3Control_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, 100663546);
		NativeMethodInfoPtr_set_sourceLossMitigationDirection_Protected_set_Void_Vector3Control_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, 100663547);
		NativeMethodInfoPtr_FinishSetup_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, 100663548);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HololensHand>.NativeClassPtr, 100663549);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 963443, XrefRangeEnd = 963467, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe HololensHand()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<HololensHand>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr);
	...
	public HololensHand(IntPtr pointer)
		: base(pointer)
	{
	}
}
