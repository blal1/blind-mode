...
public class WMRHMD : XRHMD
{
	...
	static WMRHMD()
	{
		Il2CppClassPointerStore<WMRHMD>.NativeClassPtr = IL2CPP.GetIl2CppClass("Unity.InputSystem.dll", "UnityEngine.XR.WindowsMR.Input", "WMRHMD");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<WMRHMD>.NativeClassPtr);
		NativeFieldInfoPtr__userPresence_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WMRHMD>.NativeClassPtr, "<userPresence>k__BackingField");
		NativeMethodInfoPtr_get_userPresence_Public_get_ButtonControl_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WMRHMD>.NativeClassPtr, 100663536);
		NativeMethodInfoPtr_set_userPresence_Protected_set_Void_ButtonControl_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WMRHMD>.NativeClassPtr, 100663537);
		NativeMethodInfoPtr_FinishSetup_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WMRHMD>.NativeClassPtr, 100663538);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WMRHMD>.NativeClassPtr, 100663539);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 963436, XrefRangeEnd = 963443, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe WMRHMD()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<WMRHMD>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr);
