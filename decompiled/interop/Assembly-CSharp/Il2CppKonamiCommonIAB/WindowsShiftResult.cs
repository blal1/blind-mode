...
public class WindowsShiftResult : Result
{
	...
	static WindowsShiftResult()
	{
		Il2CppClassPointerStore<WindowsShiftResult>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "KonamiCommonIAB", "WindowsShiftResult");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<WindowsShiftResult>.NativeClassPtr);
		NativeFieldInfoPtr__code = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WindowsShiftResult>.NativeClassPtr, "_code");
		NativeMethodInfoPtr_get_code_Public_Virtual_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WindowsShiftResult>.NativeClassPtr, 100665110);
		NativeMethodInfoPtr__ctor_Public_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WindowsShiftResult>.NativeClassPtr, 100665111);
		NativeMethodInfoPtr_isSuccess_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WindowsShiftResult>.NativeClassPtr, 100665112);
		NativeMethodInfoPtr_isFailure_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WindowsShiftResult>.NativeClassPtr, 100665113);
		NativeMethodInfoPtr_getResponse_Public_Virtual_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WindowsShiftResult>.NativeClassPtr, 100665114);
		NativeMethodInfoPtr_getMessage_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WindowsShiftResult>.NativeClassPtr, 100665115);
	}
	...
	public unsafe WindowsShiftResult(int r)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<WindowsShiftResult>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 50686, XrefRangeEnd = 50691, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public WindowsShiftResult(IntPtr pointer)
		: base(pointer)
	{
	}
}
