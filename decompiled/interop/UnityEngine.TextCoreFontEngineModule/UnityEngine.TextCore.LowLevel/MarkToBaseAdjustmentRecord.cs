...
public struct MarkToBaseAdjustmentRecord
{
	...
	static MarkToBaseAdjustmentRecord()
	{
		...
		NativeMethodInfoPtr_get_baseGlyphID_Public_get_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MarkToBaseAdjustmentRecord>.NativeClassPtr, 100663464);
		NativeMethodInfoPtr_set_baseGlyphID_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MarkToBaseAdjustmentRecord>.NativeClassPtr, 100663465);
		NativeMethodInfoPtr_get_baseGlyphAnchorPoint_Public_get_GlyphAnchorPoint_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MarkToBaseAdjustmentRecord>.NativeClassPtr, 100663466);
		NativeMethodInfoPtr_set_baseGlyphAnchorPoint_Public_set_Void_GlyphAnchorPoint_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MarkToBaseAdjustmentRecord>.NativeClassPtr, 100663467);
		NativeMethodInfoPtr_get_markGlyphID_Public_get_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MarkToBaseAdjustmentRecord>.NativeClassPtr, 100663468);
		NativeMethodInfoPtr_set_markGlyphID_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MarkToBaseAdjustmentRecord>.NativeClassPtr, 100663469);
		NativeMethodInfoPtr_get_markPositionAdjustment_Public_get_MarkPositionAdjustment_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MarkToBaseAdjustmentRecord>.NativeClassPtr, 100663470);
		NativeMethodInfoPtr_set_markPositionAdjustment_Public_set_Void_MarkPositionAdjustment_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MarkToBaseAdjustmentRecord>.NativeClassPtr, 100663471);
	}
